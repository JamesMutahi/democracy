...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? searchTerm,  List<Post>? previousPosts,  DateTime? startDate,  DateTime? endDate)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( List<Post> posts)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? searchTerm,  List<Post>? previousPosts,  DateTime? startDate,  DateTime? endDate)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( List<Post> posts)  update,}) {final _that = this;
switch (_that) {
case _Get():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? searchTerm,  List<Post>? previousPosts,  DateTime? startDate,  DateTime? endDate)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( List<Post> posts)?  update,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.searchTerm,_that.previousPosts,_that.startDate,_that.endDate);case _Received() when received != null:
return received(_that.payload);case _Update() when update != null:
...
class _Update implements RecentPostsEvent {
...
@override
String toString() {
  return 'RecentPostsEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $RecentPostsEventCopyWith<$Res> {
