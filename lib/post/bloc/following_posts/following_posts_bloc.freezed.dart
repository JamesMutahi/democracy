...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FollowingPostsEvent);
}
...
/// @nodoc
class $FollowingPostsEventCopyWith<$Res>  {
$FollowingPostsEventCopyWith(FollowingPostsEvent _, $Res Function(FollowingPostsEvent) __);
}


/// Adds pattern-matching-related methods to [FollowingPostsEvent].
extension FollowingPostsEventPatterns on FollowingPostsEvent {
...
@override
String toString() {
  return 'FollowingPostsEvent.get(previousPosts: $previousPosts)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $FollowingPostsEventCopyWith<$Res> {
...
class _Received implements FollowingPostsEvent {
...
@override
String toString() {
  return 'FollowingPostsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $FollowingPostsEventCopyWith<$Res> {
...
class _Update implements FollowingPostsEvent {
...
@override
String toString() {
  return 'FollowingPostsEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $FollowingPostsEventCopyWith<$Res> {
