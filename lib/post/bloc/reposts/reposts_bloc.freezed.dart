...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RepostsEvent);
}
...
/// @nodoc
class $RepostsEventCopyWith<$Res>  {
$RepostsEventCopyWith(RepostsEvent _, $Res Function(RepostsEvent) __);
}


/// Adds pattern-matching-related methods to [RepostsEvent].
extension RepostsEventPatterns on RepostsEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int postId,  User? lastUser)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( List<User> users)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.postId,_that.lastUser);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int postId,  User? lastUser)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( List<User> users)  update,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.postId,_that.lastUser);case _Received():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int postId,  User? lastUser)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( List<User> users)?  update,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.postId,_that.lastUser);case _Received() when received != null:
return received(_that.payload);case _Update() when update != null:
...
class _Get implements RepostsEvent {
  const _Get({required this.postId, this.lastUser});
  

 final  int postId;
 final  User? lastUser;

/// Create a copy of RepostsEvent
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.postId, postId) || other.postId == postId)&&(identical(other.lastUser, lastUser) || other.lastUser == lastUser));
}


@override
int get hashCode => Object.hash(runtimeType,postId,lastUser);

@override
String toString() {
  return 'RepostsEvent.get(postId: $postId, lastUser: $lastUser)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $RepostsEventCopyWith<$Res> {
  factory _$GetCopyWith(_Get value, $Res Function(_Get) _then) = __$GetCopyWithImpl;
@useResult
$Res call({
 int postId, User? lastUser
});
...
/// Create a copy of RepostsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? postId = null,Object? lastUser = freezed,}) {
  return _then(_Get(
...
class _Received implements RepostsEvent {
...
@override
String toString() {
  return 'RepostsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $RepostsEventCopyWith<$Res> {
...
class _Update implements RepostsEvent {
...
@override
String toString() {
  return 'RepostsEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $RepostsEventCopyWith<$Res> {
