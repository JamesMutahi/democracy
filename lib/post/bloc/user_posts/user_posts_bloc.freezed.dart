...
@override
String toString() {
  return 'UserPostsEvent.get(user: $user, previousPosts: $previousPosts)';
}
...
class _Update implements UserPostsEvent {
...
@override
String toString() {
  return 'UserPostsEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $UserPostsEventCopyWith<$Res> {
