...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HashtagsEvent);
}
...
/// @nodoc
class $HashtagsEventCopyWith<$Res>  {
$HashtagsEventCopyWith(HashtagsEvent _, $Res Function(HashtagsEvent) __);
}


/// Adds pattern-matching-related methods to [HashtagsEvent].
extension HashtagsEventPatterns on HashtagsEvent {
...
class _Get implements HashtagsEvent {
  const _Get({this.searchTerm = ''});
  

@JsonKey() final  String searchTerm;

/// Create a copy of HashtagsEvent
...
@override
String toString() {
  return 'HashtagsEvent.get(searchTerm: $searchTerm)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $HashtagsEventCopyWith<$Res> {
...
class _Received implements HashtagsEvent {
...
@override
String toString() {
  return 'HashtagsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $HashtagsEventCopyWith<$Res> {
