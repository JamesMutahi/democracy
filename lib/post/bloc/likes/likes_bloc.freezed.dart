...
class _Get implements LikesEvent {
...
@override
String toString() {
  return 'LikesEvent.get(user: $user, previousPosts: $previousPosts)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $LikesEventCopyWith<$Res> {
...
class _Received implements LikesEvent {
...
@override
String toString() {
  return 'LikesEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $LikesEventCopyWith<$Res> {
...
class _Update implements LikesEvent {
...
@override
String toString() {
  return 'LikesEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $LikesEventCopyWith<$Res> {
