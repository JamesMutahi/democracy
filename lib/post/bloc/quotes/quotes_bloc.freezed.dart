...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int postId,  List<Post>? previousPosts)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( int postId,  List<Post> posts)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
...
return update(_that.postId,_that.posts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int postId,  List<Post>? previousPosts)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( int postId,  List<Post> posts)  update,}) {final _that = this;
switch (_that) {
case _Get():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int postId,  List<Post>? previousPosts)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( int postId,  List<Post> posts)?  update,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.postId,_that.previousPosts);case _Received() when received != null:
return received(_that.payload);case _Update() when update != null:
...
class _Get implements QuotesEvent {
...
@override
String toString() {
  return 'QuotesEvent.get(postId: $postId, previousPosts: $previousPosts)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $QuotesEventCopyWith<$Res> {
...
class _Received implements QuotesEvent {
...
@override
String toString() {
  return 'QuotesEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $QuotesEventCopyWith<$Res> {
...
class _Update implements QuotesEvent {
  const _Update({required this.postId, required final  List<Post> posts}): _posts = posts;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Update&&(identical(other.postId, postId) || other.postId == postId)&&const DeepCollectionEquality().equals(other._posts, _posts));
}
...
@override
String toString() {
  return 'QuotesEvent.update(postId: $postId, posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $QuotesEventCopyWith<$Res> {
