...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrendingPostsEvent);
}
...
/// @nodoc
class $TrendingPostsEventCopyWith<$Res>  {
$TrendingPostsEventCopyWith(TrendingPostsEvent _, $Res Function(TrendingPostsEvent) __);
}


/// Adds pattern-matching-related methods to [TrendingPostsEvent].
extension TrendingPostsEventPatterns on TrendingPostsEvent {
...
class _Get implements TrendingPostsEvent {
...
/// Create a copy of TrendingPostsEvent
...
@override
String toString() {
  return 'TrendingPostsEvent.get(previousPosts: $previousPosts)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $TrendingPostsEventCopyWith<$Res> {
...
class _Received implements TrendingPostsEvent {
...
@override
String toString() {
  return 'TrendingPostsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $TrendingPostsEventCopyWith<$Res> {
...
class _Update implements TrendingPostsEvent {
...
@override
String toString() {
  return 'TrendingPostsEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $TrendingPostsEventCopyWith<$Res> {
