...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrendingTopicsEvent);
}
...
/// @nodoc
class $TrendingTopicsEventCopyWith<$Res>  {
$TrendingTopicsEventCopyWith(TrendingTopicsEvent _, $Res Function(TrendingTopicsEvent) __);
}


/// Adds pattern-matching-related methods to [TrendingTopicsEvent].
extension TrendingTopicsEventPatterns on TrendingTopicsEvent {
...
class _Get implements TrendingTopicsEvent {
  const _Get();
...
@override
String toString() {
  return 'TrendingTopicsEvent.get()';
}
...
class _Received implements TrendingTopicsEvent {
...
/// Create a copy of TrendingTopicsEvent
...
@override
String toString() {
  return 'TrendingTopicsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $TrendingTopicsEventCopyWith<$Res> {
