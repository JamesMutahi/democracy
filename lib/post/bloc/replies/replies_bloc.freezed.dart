...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initialize value)?  initialize,TResult Function( _Get value)?  get,TResult Function( _Received value)?  received,TResult Function( _Add value)?  add,TResult Function( _Update value)?  update,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initialize value)  initialize,required TResult Function( _Get value)  get,required TResult Function( _Received value)  received,required TResult Function( _Add value)  add,required TResult Function( _Update value)  update,}){
final _that = this;
switch (_that) {
case _Initialize():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initialize value)?  initialize,TResult? Function( _Get value)?  get,TResult? Function( _Received value)?  received,TResult? Function( _Add value)?  add,TResult? Function( _Update value)?  update,}){
final _that = this;
switch (_that) {
case _Initialize() when initialize != null:
return initialize(_that);case _Get() when get != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Post post)?  initialize,TResult Function( Post post,  List<Post>? previousPosts)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( Post post)?  add,TResult Function( List<Post> posts)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initialize() when initialize != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Post post)  initialize,required TResult Function( Post post,  List<Post>? previousPosts)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( Post post)  add,required TResult Function( List<Post> posts)  update,}) {final _that = this;
switch (_that) {
case _Initialize():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( Post post)?  initialize,TResult? Function( Post post,  List<Post>? previousPosts)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( Post post)?  add,TResult? Function( List<Post> posts)?  update,}) {final _that = this;
switch (_that) {
case _Initialize() when initialize != null:
return initialize(_that.post);case _Get() when get != null:
return get(_that.post,_that.previousPosts);case _Received() when received != null:
...
class _Initialize implements RepliesEvent {
...
@override
String toString() {
  return 'RepliesEvent.initialize(post: $post)';
}
...
/// @nodoc
abstract mixin class _$InitializeCopyWith<$Res> implements $RepliesEventCopyWith<$Res> {
...
/// @nodoc
abstract mixin class _$AddCopyWith<$Res> implements $RepliesEventCopyWith<$Res> {
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $RepliesEventCopyWith<$Res> {
