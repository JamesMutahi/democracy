...
class _Initialize implements ForYouEvent {
  const _Initialize();
...
class _Update implements ForYouEvent {
...
@override
String toString() {
  return 'ForYouEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $ForYouEventCopyWith<$Res> {
