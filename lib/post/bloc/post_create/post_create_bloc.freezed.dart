...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String body,  PostStatus status,  Post? repostOf,  RepostType? repostType,  Post? replyTo,  int? communityNoteOfId,  Ballot? ballot,  Survey? survey,  Petition? petition,  Broadcast? broadcast,  Section? section,  List<String> filePaths,  LatLng? location)?  create,TResult Function( List<dynamic> uploads)?  uploadAssets,TResult Function()?  retry,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Create() when create != null:
return create(_that.body,_that.status,_that.repostOf,_that.repostType,_that.replyTo,_that.communityNoteOfId,_that.ballot,_that.survey,_that.petition,_that.broadcast,_that.section,_that.filePaths,_that.location);case _UploadAssets() when uploadAssets != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String body,  PostStatus status,  Post? repostOf,  RepostType? repostType,  Post? replyTo,  int? communityNoteOfId,  Ballot? ballot,  Survey? survey,  Petition? petition,  Broadcast? broadcast,  Section? section,  List<String> filePaths,  LatLng? location)  create,required TResult Function( List<dynamic> uploads)  uploadAssets,required TResult Function()  retry,}) {final _that = this;
switch (_that) {
case _Create():
return create(_that.body,_that.status,_that.repostOf,_that.repostType,_that.replyTo,_that.communityNoteOfId,_that.ballot,_that.survey,_that.petition,_that.broadcast,_that.section,_that.filePaths,_that.location);case _UploadAssets():
...
class _Create implements PostCreateEvent {
  const _Create({required this.body, required this.status, this.repostOf, this.repostType, this.replyTo, this.communityNoteOfId, this.ballot, this.survey, this.petition, this.broadcast, this.section, final  List<String> filePaths = const [], this.location}): _filePaths = filePaths;
...
@override
int get hashCode => Object.hash(runtimeType,body,status,repostOf,repostType,replyTo,communityNoteOfId,ballot,survey,petition,broadcast,section,const DeepCollectionEquality().hash(_filePaths),location);

@override
String toString() {
  return 'PostCreateEvent.create(body: $body, status: $status, repostOf: $repostOf, repostType: $repostType, replyTo: $replyTo, communityNoteOfId: $communityNoteOfId, ballot: $ballot, survey: $survey, petition: $petition, broadcast: $broadcast, section: $section, filePaths: $filePaths, location: $location)';
}
...
@useResult
$Res call({
 String body, PostStatus status, Post? repostOf, RepostType? repostType, Post? replyTo, int? communityNoteOfId, Ballot? ballot, Survey? survey, Petition? petition, Broadcast? broadcast, Section? section, List<String> filePaths, LatLng? location
});
