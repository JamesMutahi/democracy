...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserRepliesEvent);
}
...
/// @nodoc
class $UserRepliesEventCopyWith<$Res>  {
$UserRepliesEventCopyWith(UserRepliesEvent _, $Res Function(UserRepliesEvent) __);
}


/// Adds pattern-matching-related methods to [UserRepliesEvent].
extension UserRepliesEventPatterns on UserRepliesEvent {
...
class _Get implements UserRepliesEvent {
...
/// Create a copy of UserRepliesEvent
...
@override
String toString() {
  return 'UserRepliesEvent.get(user: $user, previousPosts: $previousPosts)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $UserRepliesEventCopyWith<$Res> {
...
class _Received implements UserRepliesEvent {
...
@override
String toString() {
  return 'UserRepliesEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $UserRepliesEventCopyWith<$Res> {
...
class _Update implements UserRepliesEvent {
...
@override
String toString() {
  return 'UserRepliesEvent.update(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $UserRepliesEventCopyWith<$Res> {
