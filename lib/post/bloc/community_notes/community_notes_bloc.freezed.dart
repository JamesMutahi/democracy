...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Post post,  String? searchTerm,  Post? lastPost)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( Post post,  List<Post> communityNotes)?  resubscribe,TResult Function( Post post,  List<Post> communityNotes)?  unsubscribe,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.post,_that.searchTerm,_that.lastPost);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Post post,  String? searchTerm,  Post? lastPost)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( Post post,  List<Post> communityNotes)  resubscribe,required TResult Function( Post post,  List<Post> communityNotes)  unsubscribe,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.post,_that.searchTerm,_that.lastPost);case _Received():
...
class _Get implements CommunityNotesEvent {
  const _Get({required this.post, this.searchTerm, this.lastPost});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.post, post) || other.post == post)&&(identical(other.searchTerm, searchTerm) || other.searchTerm == searchTerm)&&(identical(other.lastPost, lastPost) || other.lastPost == lastPost));
}


@override
int get hashCode => Object.hash(runtimeType,post,searchTerm,lastPost);

@override
String toString() {
  return 'CommunityNotesEvent.get(post: $post, searchTerm: $searchTerm, lastPost: $lastPost)';
}
...
@useResult
$Res call({
 Post post, String? searchTerm, Post? lastPost
});
...
/// Create a copy of CommunityNotesEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? post = null,Object? searchTerm = freezed,Object? lastPost = freezed,}) {
  return _then(_Get(
