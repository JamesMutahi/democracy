...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Post post,  Post? lastPost)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( Post post,  List<Post> communityNotes)  resubscribe,required TResult Function( Post post,  List<Post> communityNotes)  unsubscribe,}) {final _that = this;
switch (_that) {
case _Get():
...
@override
String toString() {
  return 'CommunityNotesEvent.get(post: $post, lastPost: $lastPost)';
}
