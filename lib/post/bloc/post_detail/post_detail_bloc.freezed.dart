...
return update(_that);case _Like() when like != null:
return like(_that);case _Bookmark() when bookmark != null:
return bookmark(_that);case _Delete() when delete != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Created value)  created,required TResult Function( _Loaded value)  loaded,required TResult Function( _Updated value)  updated,required TResult Function( _Deleted value)  deleted,required TResult Function( _Reported value)  reported,required TResult Function( _Create value)  create,required TResult Function( _Get value)  get,required TResult Function( _Update value)  update,required TResult Function( _Like value)  like,required TResult Function( _Bookmark value)  bookmark,required TResult Function( _Delete value)  delete,required TResult Function( _DeleteRepost value)  deleteRepost,required TResult Function( _Report value)  report,}){
final _that = this;
switch (_that) {
case _Created():
...
return update(_that);case _Like():
return like(_that);case _Bookmark():
return bookmark(_that);case _Delete():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Created value)?  created,TResult? Function( _Loaded value)?  loaded,TResult? Function( _Updated value)?  updated,TResult? Function( _Deleted value)?  deleted,TResult? Function( _Reported value)?  reported,TResult? Function( _Create value)?  create,TResult? Function( _Get value)?  get,TResult? Function( _Update value)?  update,TResult? Function( _Like value)?  like,TResult? Function( _Bookmark value)?  bookmark,TResult? Function( _Delete value)?  delete,TResult? Function( _DeleteRepost value)?  deleteRepost,TResult? Function( _Report value)?  report,}){
final _that = this;
switch (_that) {
case _Created() when created != null:
return created(_that);case _Loaded() when loaded != null:
...
return create(_that.body,_that.status,_that.repostOf,_that.replyTo,_that.ballot,_that.survey,_that.petition,_that.tags);case _Get() when get != null:
return get(_that.post);case _Update() when update != null:
return update(_that.id,_that.body);case _Like() when like != null:
return like(_that.post);case _Bookmark() when bookmark != null:
return bookmark(_that.post);case _Delete() when delete != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Map<String, dynamic> payload)  created,required TResult Function( Map<String, dynamic> payload)  loaded,required TResult Function( Map<String, dynamic> payload)  updated,required TResult Function( Map<String, dynamic> payload)  deleted,required TResult Function( Map<String, dynamic> payload)  reported,required TResult Function( String body,  PostStatus status,  Post? repostOf,  Post? replyTo,  Ballot? ballot,  Survey? survey,  Petition? petition,  List<Map> tags)  create,required TResult Function( Post post)  get,required TResult Function( int id,  String body)  update,required TResult Function( Post post)  like,required TResult Function( Post post)  bookmark,required TResult Function( Post post)  delete,required TResult Function( Post post)  deleteRepost,required TResult Function( String issue,  Post post)  report,}) {final _that = this;
switch (_that) {
case _Created():
...
return create(_that.body,_that.status,_that.repostOf,_that.replyTo,_that.ballot,_that.survey,_that.petition,_that.tags);case _Get():
return get(_that.post);case _Update():
return update(_that.id,_that.body);case _Like():
return like(_that.post);case _Bookmark():
return bookmark(_that.post);case _Delete():
...
class _Create implements PostDetailEvent {
  const _Create({required this.body, required this.status, required this.repostOf, required this.replyTo, required this.ballot, required this.survey, required this.petition, required final  List<Map> tags}): _tags = tags;
...
@override
String toString() {
  return 'PostDetailEvent.create(body: $body, status: $status, repostOf: $repostOf, replyTo: $replyTo, ballot: $ballot, survey: $survey, petition: $petition, tags: $tags)';
}
...
class _Update implements PostDetailEvent {
  const _Update({required this.id, required this.body});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Update&&(identical(other.id, id) || other.id == id)&&(identical(other.body, body) || other.body == body));
}
...
@override
String toString() {
  return 'PostDetailEvent.update(id: $id, body: $body)';
}
