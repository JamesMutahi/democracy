...
return update(_that.id,_that.body,_that.status,_that.tags);case _AddView() when addView != null:
...
return update(_that.id,_that.body,_that.status,_that.tags);case _AddView():
