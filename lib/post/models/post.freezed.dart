...
@useResult
$Res call({
 int id, User author,@PostStatusConverter() PostStatus status, String body, String? image1Url, String? image2Url, String? image3Url, String? image4Url, String? image5Url, String? image6Url, String? video1Url, String? video2Url, String? video3Url, int likes,@JsonKey(name: 'is_liked') bool isLiked, int bookmarks,@JsonKey(name: 'is_bookmarked') bool isBookmarked, int views, int replies, int reposts,@JsonKey(name: 'is_edited') bool isEdited,@JsonKey(name: 'is_deleted') bool isDeleted,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'published_at') DateTime publishedAt,@JsonKey(name: 'reply_to') Post? replyTo,@JsonKey(name: 'repost_of') Post? repostOf, Ballot? ballot, Survey? survey, Petition? petition,@JsonKey(name: 'tagged_users') List<User> taggedUsers
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  User author, @PostStatusConverter()  PostStatus status,  String body,  String? image1Url,  String? image2Url,  String? image3Url,  String? image4Url,  String? image5Url,  String? image6Url,  String? video1Url,  String? video2Url,  String? video3Url,  int likes, @JsonKey(name: 'is_liked')  bool isLiked,  int bookmarks, @JsonKey(name: 'is_bookmarked')  bool isBookmarked,  int views,  int replies,  int reposts, @JsonKey(name: 'is_edited')  bool isEdited, @JsonKey(name: 'is_deleted')  bool isDeleted, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'published_at')  DateTime publishedAt, @JsonKey(name: 'reply_to')  Post? replyTo, @JsonKey(name: 'repost_of')  Post? repostOf,  Ballot? ballot,  Survey? survey,  Petition? petition, @JsonKey(name: 'tagged_users')  List<User> taggedUsers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Post() when $default != null:
return $default(_that.id,_that.author,_that.status,_that.body,_that.image1Url,_that.image2Url,_that.image3Url,_that.image4Url,_that.image5Url,_that.image6Url,_that.video1Url,_that.video2Url,_that.video3Url,_that.likes,_that.isLiked,_that.bookmarks,_that.isBookmarked,_that.views,_that.replies,_that.reposts,_that.isEdited,_that.isDeleted,_that.isActive,_that.publishedAt,_that.replyTo,_that.repostOf,_that.ballot,_that.survey,_that.petition,_that.taggedUsers);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  User author, @PostStatusConverter()  PostStatus status,  String body,  String? image1Url,  String? image2Url,  String? image3Url,  String? image4Url,  String? image5Url,  String? image6Url,  String? video1Url,  String? video2Url,  String? video3Url,  int likes, @JsonKey(name: 'is_liked')  bool isLiked,  int bookmarks, @JsonKey(name: 'is_bookmarked')  bool isBookmarked,  int views,  int replies,  int reposts, @JsonKey(name: 'is_edited')  bool isEdited, @JsonKey(name: 'is_deleted')  bool isDeleted, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'published_at')  DateTime publishedAt, @JsonKey(name: 'reply_to')  Post? replyTo, @JsonKey(name: 'repost_of')  Post? repostOf,  Ballot? ballot,  Survey? survey,  Petition? petition, @JsonKey(name: 'tagged_users')  List<User> taggedUsers)  $default,) {final _that = this;
switch (_that) {
case _Post():
return $default(_that.id,_that.author,_that.status,_that.body,_that.image1Url,_that.image2Url,_that.image3Url,_that.image4Url,_that.image5Url,_that.image6Url,_that.video1Url,_that.video2Url,_that.video3Url,_that.likes,_that.isLiked,_that.bookmarks,_that.isBookmarked,_that.views,_that.replies,_that.reposts,_that.isEdited,_that.isDeleted,_that.isActive,_that.publishedAt,_that.replyTo,_that.repostOf,_that.ballot,_that.survey,_that.petition,_that.taggedUsers);}
}
...
class _Post implements Post {
  const _Post({required this.id, required this.author, @PostStatusConverter() required this.status, required this.body, required this.image1Url, required this.image2Url, required this.image3Url, required this.image4Url, required this.image5Url, required this.image6Url, required this.video1Url, required this.video2Url, required this.video3Url, required this.likes, @JsonKey(name: 'is_liked') required this.isLiked, required this.bookmarks, @JsonKey(name: 'is_bookmarked') required this.isBookmarked, required this.views, required this.replies, required this.reposts, @JsonKey(name: 'is_edited') required this.isEdited, @JsonKey(name: 'is_deleted') required this.isDeleted, @JsonKey(name: 'is_active') required this.isActive, @JsonKey(name: 'published_at') required this.publishedAt, @JsonKey(name: 'reply_to') required this.replyTo, @JsonKey(name: 'repost_of') required this.repostOf, required this.ballot, required this.survey, required this.petition, @JsonKey(name: 'tagged_users') required final  List<User> taggedUsers}): _taggedUsers = taggedUsers;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Post&&(identical(other.id, id) || other.id == id)&&(identical(other.author, author) || other.author == author)&&(identical(other.status, status) || other.status == status)&&(identical(other.body, body) || other.body == body)&&(identical(other.image1Url, image1Url) || other.image1Url == image1Url)&&(identical(other.image2Url, image2Url) || other.image2Url == image2Url)&&(identical(other.image3Url, image3Url) || other.image3Url == image3Url)&&(identical(other.image4Url, image4Url) || other.image4Url == image4Url)&&(identical(other.image5Url, image5Url) || other.image5Url == image5Url)&&(identical(other.image6Url, image6Url) || other.image6Url == image6Url)&&(identical(other.video1Url, video1Url) || other.video1Url == video1Url)&&(identical(other.video2Url, video2Url) || other.video2Url == video2Url)&&(identical(other.video3Url, video3Url) || other.video3Url == video3Url)&&(identical(other.likes, likes) || other.likes == likes)&&(identical(other.isLiked, isLiked) || other.isLiked == isLiked)&&(identical(other.bookmarks, bookmarks) || other.bookmarks == bookmarks)&&(identical(other.isBookmarked, isBookmarked) || other.isBookmarked == isBookmarked)&&(identical(other.views, views) || other.views == views)&&(identical(other.replies, replies) || other.replies == replies)&&(identical(other.reposts, reposts) || other.reposts == reposts)&&(identical(other.isEdited, isEdited) || other.isEdited == isEdited)&&(identical(other.isDeleted, isDeleted) || other.isDeleted == isDeleted)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.publishedAt, publishedAt) || other.publishedAt == publishedAt)&&(identical(other.replyTo, replyTo) || other.replyTo == replyTo)&&(identical(other.repostOf, repostOf) || other.repostOf == repostOf)&&(identical(other.ballot, ballot) || other.ballot == ballot)&&(identical(other.survey, survey) || other.survey == survey)&&(identical(other.petition, petition) || other.petition == petition)&&const DeepCollectionEquality().equals(other._taggedUsers, _taggedUsers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,author,status,body,image1Url,image2Url,image3Url,image4Url,image5Url,image6Url,video1Url,video2Url,video3Url,likes,isLiked,bookmarks,isBookmarked,views,replies,reposts,isEdited,isDeleted,isActive,publishedAt,replyTo,repostOf,ballot,survey,petition,const DeepCollectionEquality().hash(_taggedUsers)]);
