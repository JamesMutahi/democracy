...
class _Post implements Post {
  const _Post({required this.id, required this.author, @PostStatusConverter() required this.status, required this.body, @JsonKey(name: 'image1') required this.image1Url, @JsonKey(name: 'image2') required this.image2Url, @JsonKey(name: 'image3') required this.image3Url, @JsonKey(name: 'image4') required this.image4Url, @JsonKey(name: 'video') required this.videoUrl, @JsonKey(name: 'file') required this.fileUrl, required this.location, required this.likes, @JsonKey(name: 'is_liked') required this.isLiked, required this.bookmarks, @JsonKey(name: 'is_bookmarked') required this.isBookmarked, required this.views, @JsonKey(name: 'is_viewed') required this.isViewed, required this.replies, required this.reposts, @JsonKey(name: 'is_reposted') required this.isReposted, @JsonKey(name: 'is_quoted') required this.isQuoted, @JsonKey(name: 'is_deleted') required this.isDeleted, @JsonKey(name: 'is_active') required this.isActive, @JsonKey(name: 'published_at') required this.publishedAt, @JsonKey(name: 'reply_to') required this.replyTo, @JsonKey(name: 'repost_of') required this.repostOf, @JsonKey(name: 'community_note_of') required this.communityNoteOf, required this.ballot, required this.survey, required this.petition, required this.meeting, required this.section, @JsonKey(name: 'tagged_users') required final  List<User> taggedUsers, @JsonKey(name: 'is_upvoted') required this.isUpvoted, @JsonKey(name: 'is_downvoted') required this.isDownvoted, required this.upvotes, required this.downvotes, @JsonKey(defaultValue: []) required final  List<Post> thread, @JsonKey(name: 'community_note') required this.communityNote}): _taggedUsers = taggedUsers,_thread = thread;
