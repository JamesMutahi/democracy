...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,author,status,body,const DeepCollectionEquality().hash(assets),location,likes,isLiked,bookmarks,isBookmarked,views,isMuted,isPinned,replies,reposts,isReposted,isQuoted,isDeleted,isActive,publishedAt,replyTo,repostOf,repostType,communityNoteOf,ballot,survey,petition,broadcast,section,const DeepCollectionEquality().hash(taggedUsers),isUpvoted,isDownvoted,upvotes,downvotes,const DeepCollectionEquality().hash(thread),communityNote]);

@override
String toString() {
  return 'Post(id: $id, author: $author, status: $status, body: $body, assets: $assets, location: $location, likes: $likes, isLiked: $isLiked, bookmarks: $bookmarks, isBookmarked: $isBookmarked, views: $views, isMuted: $isMuted, isPinned: $isPinned, replies: $replies, reposts: $reposts, isReposted: $isReposted, isQuoted: $isQuoted, isDeleted: $isDeleted, isActive: $isActive, publishedAt: $publishedAt, replyTo: $replyTo, repostOf: $repostOf, repostType: $repostType, communityNoteOf: $communityNoteOf, ballot: $ballot, survey: $survey, petition: $petition, broadcast: $broadcast, section: $section, taggedUsers: $taggedUsers, isUpvoted: $isUpvoted, isDownvoted: $isDownvoted, upvotes: $upvotes, downvotes: $downvotes, thread: $thread, communityNote: $communityNote)';
}
...
@useResult
$Res call({
 int id, User author,@PostStatusConverter() PostStatus status, String body, List<Asset> assets, LatLng? location, int likes,@JsonKey(name: 'is_liked') bool isLiked, int bookmarks,@JsonKey(name: 'is_bookmarked') bool isBookmarked, int views,@JsonKey(name: 'is_muted') bool isMuted,@JsonKey(name: 'is_pinned') bool isPinned, int replies, int reposts,@JsonKey(name: 'is_reposted') bool isReposted,@JsonKey(name: 'is_quoted') bool isQuoted,@JsonKey(name: 'is_deleted') bool isDeleted,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'published_at') DateTime publishedAt,@JsonKey(name: 'reply_to') Post? replyTo,@JsonKey(name: 'repost_of') Post? repostOf,@JsonKey(name: 'repost_type')@RepostTypeConverter() RepostType? repostType,@JsonKey(name: 'community_note_of') Post? communityNoteOf, Ballot? ballot, Survey? survey, Petition? petition, Broadcast? broadcast, Section? section,@JsonKey(name: 'tagged_users') List<User> taggedUsers,@JsonKey(name: 'is_upvoted') bool isUpvoted,@JsonKey(name: 'is_downvoted') bool isDownvoted, int upvotes, int downvotes,@JsonKey(defaultValue: []) List<Post> thread,@JsonKey(name: 'community_note') String communityNote
});


$UserCopyWith<$Res> get author;$PostCopyWith<$Res>? get replyTo;$PostCopyWith<$Res>? get repostOf;$PostCopyWith<$Res>? get communityNoteOf;$BallotCopyWith<$Res>? get ballot;$SurveyCopyWith<$Res>? get survey;$PetitionCopyWith<$Res>? get petition;$BroadcastCopyWith<$Res>? get broadcast;$SectionCopyWith<$Res>? get section;
...
/// Create a copy of Post
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? author = null,Object? status = null,Object? body = null,Object? assets = null,Object? location = freezed,Object? likes = null,Object? isLiked = null,Object? bookmarks = null,Object? isBookmarked = null,Object? views = null,Object? isMuted = null,Object? isPinned = null,Object? replies = null,Object? reposts = null,Object? isReposted = null,Object? isQuoted = null,Object? isDeleted = null,Object? isActive = null,Object? publishedAt = null,Object? replyTo = freezed,Object? repostOf = freezed,Object? repostType = freezed,Object? communityNoteOf = freezed,Object? ballot = freezed,Object? survey = freezed,Object? petition = freezed,Object? broadcast = freezed,Object? section = freezed,Object? taggedUsers = null,Object? isUpvoted = null,Object? isDownvoted = null,Object? upvotes = null,Object? downvotes = null,Object? thread = null,Object? communityNote = null,}) {
...
as RepostType?,communityNoteOf: freezed == communityNoteOf ? _self.communityNoteOf : communityNoteOf // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Post() when $default != null:
return $default(_that.id,_that.author,_that.status,_that.body,_that.assets,_that.location,_that.likes,_that.isLiked,_that.bookmarks,_that.isBookmarked,_that.views,_that.isMuted,_that.isPinned,_that.replies,_that.reposts,_that.isReposted,_that.isQuoted,_that.isDeleted,_that.isActive,_that.publishedAt,_that.replyTo,_that.repostOf,_that.repostType,_that.communityNoteOf,_that.ballot,_that.survey,_that.petition,_that.broadcast,_that.section,_that.taggedUsers,_that.isUpvoted,_that.isDownvoted,_that.upvotes,_that.downvotes,_that.thread,_that.communityNote);case _:
  return orElse();
...
switch (_that) {
case _Post():
return $default(_that.id,_that.author,_that.status,_that.body,_that.assets,_that.location,_that.likes,_that.isLiked,_that.bookmarks,_that.isBookmarked,_that.views,_that.isMuted,_that.isPinned,_that.replies,_that.reposts,_that.isReposted,_that.isQuoted,_that.isDeleted,_that.isActive,_that.publishedAt,_that.replyTo,_that.repostOf,_that.repostType,_that.communityNoteOf,_that.ballot,_that.survey,_that.petition,_that.broadcast,_that.section,_that.taggedUsers,_that.isUpvoted,_that.isDownvoted,_that.upvotes,_that.downvotes,_that.thread,_that.communityNote);}
}
...
class _Post implements Post {
  const _Post({required this.id, required this.author, @PostStatusConverter() required this.status, required this.body, required final  List<Asset> assets, required this.location, required this.likes, @JsonKey(name: 'is_liked') required this.isLiked, required this.bookmarks, @JsonKey(name: 'is_bookmarked') required this.isBookmarked, required this.views, @JsonKey(name: 'is_muted') required this.isMuted, @JsonKey(name: 'is_pinned') required this.isPinned, required this.replies, required this.reposts, @JsonKey(name: 'is_reposted') required this.isReposted, @JsonKey(name: 'is_quoted') required this.isQuoted, @JsonKey(name: 'is_deleted') required this.isDeleted, @JsonKey(name: 'is_active') required this.isActive, @JsonKey(name: 'published_at') required this.publishedAt, @JsonKey(name: 'reply_to') required this.replyTo, @JsonKey(name: 'repost_of') required this.repostOf, @JsonKey(name: 'repost_type')@RepostTypeConverter() required this.repostType, @JsonKey(name: 'community_note_of') required this.communityNoteOf, required this.ballot, required this.survey, required this.petition, required this.broadcast, required this.section, @JsonKey(name: 'tagged_users') required final  List<User> taggedUsers, @JsonKey(name: 'is_upvoted') required this.isUpvoted, @JsonKey(name: 'is_downvoted') required this.isDownvoted, required this.upvotes, required this.downvotes, @JsonKey(defaultValue: []) required final  List<Post> thread, @JsonKey(name: 'community_note') required this.communityNote}): _assets = assets,_taggedUsers = taggedUsers,_thread = thread;
...
@override@JsonKey(name: 'repost_type')@RepostTypeConverter() final  RepostType? repostType;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,author,status,body,const DeepCollectionEquality().hash(_assets),location,likes,isLiked,bookmarks,isBookmarked,views,isMuted,isPinned,replies,reposts,isReposted,isQuoted,isDeleted,isActive,publishedAt,replyTo,repostOf,repostType,communityNoteOf,ballot,survey,petition,broadcast,section,const DeepCollectionEquality().hash(_taggedUsers),isUpvoted,isDownvoted,upvotes,downvotes,const DeepCollectionEquality().hash(_thread),communityNote]);
