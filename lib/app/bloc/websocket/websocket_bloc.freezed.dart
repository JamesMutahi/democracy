...
return unsubscribeUserPetitions(_that);case _Disconnect() when disconnect != null:
...
return unsubscribeUserPetitions(_that);case _Disconnect():
return disconnect(_that);case _:
...
return unsubscribeUserPetitions(_that.user,_that.petitions);case _Disconnect() when disconnect != null:
...
return unsubscribeUserPetitions(_that.user,_that.petitions);case _Disconnect():
return disconnect();case _:
  throw StateError('Unexpected subclass');
