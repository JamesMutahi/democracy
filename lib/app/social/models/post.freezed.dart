...
mixin _$Post {
 ...
 int get id; User get author; String get body; String? get image1Url; String? get image2Url; String? get image3Url; String? get image4Url; String? get image5Url; String? get image6Url; String? get video1Url; String? get video2Url; String? get video3Url; int get likes; int get views; int get replies; int get reposts;@JsonKey(name: 'is_edited') bool get isEdited;@JsonKey(name: 'is_deleted') bool get isDeleted;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'published_at') DateTime get publishedAt;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'reply_to') Post? get replyTo;@JsonKey(name: 'repost_of') Post? get repostOf;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,author,body,image1Url,image2Url,image3Url,image4Url,image5Url,image6Url,video1Url,video2Url,video3Url,likes,views,replies,reposts,isEdited,isDeleted,isActive,publishedAt,createdAt,updatedAt,replyTo,repostOf]);

@override
String toString() {
  return 'Post(id: $id, author: $author, body: $body, image1Url: $image1Url, image2Url: $image2Url, image3Url: $image3Url, image4Url: $image4Url, image5Url: $image5Url, image6Url: $image6Url, video1Url: $video1Url, video2Url: $video2Url, video3Url: $video3Url, likes: $likes, views: $views, replies: $replies, reposts: $reposts, isEdited: $isEdited, isDeleted: $isDeleted, isActive: $isActive, publishedAt: $publishedAt, createdAt: $createdAt, updatedAt: $updatedAt, replyTo: $replyTo, repostOf: $repostOf)';
}
...
@useResult
$Res call({
 int id, User author, String body, String? image1Url, String? image2Url, String? image3Url, String? image4Url, String? image5Url, String? image6Url, String? video1Url, String? video2Url, String? video3Url, int likes, int views, int replies, int reposts,@JsonKey(name: 'is_edited') bool isEdited,@JsonKey(name: 'is_deleted') bool isDeleted,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'published_at') DateTime publishedAt,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'reply_to') Post? replyTo,@JsonKey(name: 'repost_of') Post? repostOf
});
...
/// Create a copy of Post
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? author = null,Object? body = null,Object? image1Url = freezed,Object? image2Url = freezed,Object? image3Url = freezed,Object? image4Url = freezed,Object? image5Url = freezed,Object? image6Url = freezed,Object? video1Url = freezed,Object? video2Url = freezed,Object? video3Url = freezed,Object? likes = null,Object? views = null,Object? replies = null,Object? reposts = null,Object? isEdited = null,Object? isDeleted = null,Object? isActive = null,Object? publishedAt = null,Object? createdAt = null,Object? updatedAt = null,Object? replyTo = freezed,Object? repostOf = freezed,}) {
...
class _Post implements Post {
  const _Post({required this.id, required this.author, required this.body, required this.image1Url, required this.image2Url, required this.image3Url, required this.image4Url, required this.image5Url, required this.image6Url, required this.video1Url, required this.video2Url, required this.video3Url, required this.likes, required this.views, required this.replies, required this.reposts, @JsonKey(name: 'is_edited') required this.isEdited, @JsonKey(name: 'is_deleted') required this.isDeleted, @JsonKey(name: 'is_active') required this.isActive, @JsonKey(name: 'published_at') required this.publishedAt, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'reply_to') required this.replyTo, @JsonKey(name: 'repost_of') required this.repostOf});
...
/// Create a copy of Post
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? author = null,Object? body = null,Object? image1Url = freezed,Object? image2Url = freezed,Object? image3Url = freezed,Object? image4Url = freezed,Object? image5Url = freezed,Object? image6Url = freezed,Object? video1Url = freezed,Object? video2Url = freezed,Object? video3Url = freezed,Object? likes = null,Object? views = null,Object? replies = null,Object? reposts = null,Object? isEdited = null,Object? isDeleted = null,Object? isActive = null,Object? publishedAt = null,Object? createdAt = null,Object? updatedAt = null,Object? replyTo = freezed,Object? repostOf = freezed,}) {
  return _then(_Post(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,author: null == author ? _self.author : author // ignore: cast_nullable_to_non_nullable
as User,body: null == body ? _self.body : body // ignore: cast_nullable_to_non_nullable
