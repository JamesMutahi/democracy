...
mixin _$Survey {
  ...
  @JsonKey(name: 'is_poll') bool get isPoll;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Survey &&
...
abstract mixin class $SurveyCopyWith<$Res> {
  factory $SurveyCopyWith(Survey value,
      $Res Function(Survey) _then) = _$SurveyCopyWithImpl;

  @useResult
  $Res call({
    int id, String name, String description, @JsonKey(
        name: 'is_poll') bool isPoll, DateTime start, DateTime end, List options
  });
...
class _$SurveyCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? name = null, Object? description = null, Object? isPoll = null, Object? start = null, Object? end = null, Object? options = null,}) {
...
class _Survey implements Survey {
  const _Survey(
      {required this.id, required this.name, required this.description, @JsonKey(
          name: 'is_poll') required this.isPoll, required this.start, required this.end, required final List options})
      : _options = options;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Survey &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
...
abstract mixin class _$SurveyCopyWith<$Res> implements $SurveyCopyWith<$Res> {
  factory _$SurveyCopyWith(_Survey value,
      $Res Function(_Survey) _then) = __$SurveyCopyWithImpl;
