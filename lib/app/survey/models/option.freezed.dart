...
mixin _$Option {
 ...
 int get id; int get survey; String get text;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Option&&(identical(other.id, id) || other.id == id)&&(identical(other.survey, survey) || other.survey == survey)&&(identical(other.text, text) || other.text == text));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,survey,text);

@override
String toString() {
  return 'Option(id: $id, survey: $survey, text: $text)';
}
...
/// Create a copy of Option
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? survey = null,Object? text = null,}) {
...
class _Option implements Option {
  const _Option({required this.id, required this.survey, required this.text});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Option&&(identical(other.id, id) || other.id == id)&&(identical(other.survey, survey) || other.survey == survey)&&(identical(other.text, text) || other.text == text));
}
...
/// Create a copy of Option
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? survey = null,Object? text = null,}) {
