...
import 'package:democracy/app/view/dashboard.dart' as _i13;
...
import 'package:democracy/constitution/models/section.dart' as _i60;
...
/// generated route for
/// [_i11.Constitution]
class Constitution extends _i49.PageRouteInfo<ConstitutionArgs> {
  Constitution({
    _i50.Key? key,
    int? sectionId,
...
/// generated route for
/// [_i12.CreateMessage]
class CreateMessage extends _i49.PageRouteInfo<void> {
  const CreateMessage({List<_i49.PageRouteInfo>? children})
...
/// generated route for
/// [_i39.Reposts]
class Reposts extends _i49.PageRouteInfo<RepostsArgs> {
  Reposts({
    _i50.Key? key,
    required int postId,
    List<_i49.PageRouteInfo>? children,
         ...
         Reposts.name,
         args: RepostsArgs(key: key, postId: postId),
         rawPathParams: {'id': postId},
         initialChildren: children,
       );

  static const String name = 'Reposts';

  static _i49.PageInfo page = _i49.PageInfo(
    name,
    builder: (data) {
      final pathParams = data.inheritedPathParams;
      final args = data.argsAs<RepostsArgs>(
        orElse: () => RepostsArgs(postId: pathParams.getInt('id')),
      );
      return _i39.Reposts(key: args.key, postId: args.postId);
    },
  );
}
...
class RepostsArgs {
  ...
  @override
  String toString() {
    return 'RepostsArgs{key: $key, postId: $postId}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! RepostsArgs) return false;
    return key == other.key && postId == other.postId;
  }
