...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,county,constituency,ward,startTime,endTime,totalVotes,votedOption,hasStarted,hasEnded,isActive,const DeepCollectionEquality().hash(options),reason);

@override
String toString() {
  return 'Ballot(id: $id, title: $title, description: $description, county: $county, constituency: $constituency, ward: $ward, startTime: $startTime, endTime: $endTime, totalVotes: $totalVotes, votedOption: $votedOption, hasStarted: $hasStarted, hasEnded: $hasEnded, isActive: $isActive, options: $options, reason: $reason)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,county,constituency,ward,startTime,endTime,totalVotes,votedOption,hasStarted,hasEnded,isActive,const DeepCollectionEquality().hash(_options),reason);
