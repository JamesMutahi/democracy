...
mixin _$Ballot {
 ...
 int get id; String get title; String get description; County? get county; Constituency? get constituency; Ward? get ward;@JsonKey(name: 'start_time') DateTime get startTime;@JsonKey(name: 'end_time') DateTime get endTime;@JsonKey(name: 'total_votes') int get totalVotes;@JsonKey(name: 'voted_option') int? get votedOption;@JsonKey(name: 'has_started') bool get hasStarted;@JsonKey(name: 'has_ended') bool get hasEnded;@JsonKey(name: 'is_active') bool get isActive; List<Option> get options; String? get reason; BallotSummary? get summary;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,county,constituency,ward,startTime,endTime,totalVotes,votedOption,hasStarted,hasEnded,isActive,const DeepCollectionEquality().hash(options),reason,summary);

@override
String toString() {
  return 'Ballot(id: $id, title: $title, description: $description, county: $county, constituency: $constituency, ward: $ward, startTime: $startTime, endTime: $endTime, totalVotes: $totalVotes, votedOption: $votedOption, hasStarted: $hasStarted, hasEnded: $hasEnded, isActive: $isActive, options: $options, reason: $reason, summary: $summary)';
}
...
@useResult
$Res call({
 int id, String title, String description, County? county, Constituency? constituency, Ward? ward,@JsonKey(name: 'start_time') DateTime startTime,@JsonKey(name: 'end_time') DateTime endTime,@JsonKey(name: 'total_votes') int totalVotes,@JsonKey(name: 'voted_option') int? votedOption,@JsonKey(name: 'has_started') bool hasStarted,@JsonKey(name: 'has_ended') bool hasEnded,@JsonKey(name: 'is_active') bool isActive, List<Option> options, String? reason, BallotSummary? summary
});


$CountyCopyWith<$Res>? get county;$ConstituencyCopyWith<$Res>? get constituency;$WardCopyWith<$Res>? get ward;$BallotSummaryCopyWith<$Res>? get summary;
...
/// Create a copy of Ballot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? county = freezed,Object? constituency = freezed,Object? ward = freezed,Object? startTime = null,Object? endTime = null,Object? totalVotes = null,Object? votedOption = freezed,Object? hasStarted = null,Object? hasEnded = null,Object? isActive = null,Object? options = null,Object? reason = freezed,Object? summary = freezed,}) {
...
@override
@pragma('vm:prefer-inline')
$BallotSummaryCopyWith<$Res>? get summary {
    if (_self.summary == null) {
    return null;
  }

  return $BallotSummaryCopyWith<$Res>(_self.summary!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward, @JsonKey(name: 'start_time')  DateTime startTime, @JsonKey(name: 'end_time')  DateTime endTime, @JsonKey(name: 'total_votes')  int totalVotes, @JsonKey(name: 'voted_option')  int? votedOption, @JsonKey(name: 'has_started')  bool hasStarted, @JsonKey(name: 'has_ended')  bool hasEnded, @JsonKey(name: 'is_active')  bool isActive,  List<Option> options,  String? reason,  BallotSummary? summary)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ballot() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.startTime,_that.endTime,_that.totalVotes,_that.votedOption,_that.hasStarted,_that.hasEnded,_that.isActive,_that.options,_that.reason,_that.summary);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward, @JsonKey(name: 'start_time')  DateTime startTime, @JsonKey(name: 'end_time')  DateTime endTime, @JsonKey(name: 'total_votes')  int totalVotes, @JsonKey(name: 'voted_option')  int? votedOption, @JsonKey(name: 'has_started')  bool hasStarted, @JsonKey(name: 'has_ended')  bool hasEnded, @JsonKey(name: 'is_active')  bool isActive,  List<Option> options,  String? reason,  BallotSummary? summary)  $default,) {final _that = this;
switch (_that) {
case _Ballot():
return $default(_that.id,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.startTime,_that.endTime,_that.totalVotes,_that.votedOption,_that.hasStarted,_that.hasEnded,_that.isActive,_that.options,_that.reason,_that.summary);}
}
...
class _Ballot implements Ballot {
  const _Ballot({required this.id, required this.title, required this.description, required this.county, required this.constituency, required this.ward, @JsonKey(name: 'start_time') required this.startTime, @JsonKey(name: 'end_time') required this.endTime, @JsonKey(name: 'total_votes') required this.totalVotes, @JsonKey(name: 'voted_option') required this.votedOption, @JsonKey(name: 'has_started') required this.hasStarted, @JsonKey(name: 'has_ended') required this.hasEnded, @JsonKey(name: 'is_active') required this.isActive, required final  List<Option> options, required this.reason, required this.summary}): _options = options;
...
@override final  BallotSummary? summary;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,county,constituency,ward,startTime,endTime,totalVotes,votedOption,hasStarted,hasEnded,isActive,const DeepCollectionEquality().hash(_options),reason,summary);
...
@override $CountyCopyWith<$Res>? get county;@override $ConstituencyCopyWith<$Res>? get constituency;@override $WardCopyWith<$Res>? get ward;@override $BallotSummaryCopyWith<$Res>? get summary;
...
/// Create a copy of Ballot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? county = freezed,Object? constituency = freezed,Object? ward = freezed,Object? startTime = null,Object? endTime = null,Object? totalVotes = null,Object? votedOption = freezed,Object? hasStarted = null,Object? hasEnded = null,Object? isActive = null,Object? options = null,Object? reason = freezed,Object? summary = freezed,}) {
