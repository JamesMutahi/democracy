...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? searchTerm,  Ballot? lastBallot,  DateTime? startDate,  DateTime? endDate)?  get,TResult Function( Map<String, dynamic> payload)?  received,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.searchTerm,_that.lastBallot,_that.startDate,_that.endDate);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? searchTerm,  Ballot? lastBallot,  DateTime? startDate,  DateTime? endDate)  get,required TResult Function( Map<String, dynamic> payload)  received,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.searchTerm,_that.lastBallot,_that.startDate,_that.endDate);case _Received():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? searchTerm,  Ballot? lastBallot,  DateTime? startDate,  DateTime? endDate)?  get,TResult? Function( Map<String, dynamic> payload)?  received,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.searchTerm,_that.lastBallot,_that.startDate,_that.endDate);case _Received() when received != null:
return received(_that.payload);case _:
...
class _Get implements BallotsEvent {
  const _Get({this.searchTerm, this.lastBallot, this.startDate, this.endDate});
...
@override
int get hashCode => Object.hash(runtimeType,searchTerm,lastBallot,startDate,endDate);

@override
String toString() {
  return 'BallotsEvent.get(searchTerm: $searchTerm, lastBallot: $lastBallot, startDate: $startDate, endDate: $endDate)';
}
...
@useResult
$Res call({
 String? searchTerm, Ballot? lastBallot, DateTime? startDate, DateTime? endDate
});
...
/// Create a copy of BallotsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? searchTerm = freezed,Object? lastBallot = freezed,Object? startDate = freezed,Object? endDate = freezed,}) {
  return _then(_Get(
...
as Ballot?,startDate: freezed == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
