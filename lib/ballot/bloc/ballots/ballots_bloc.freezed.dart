...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? searchTerm,  Ballot? lastBallot)?  get,TResult Function( Map<String, dynamic> payload)?  received,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.searchTerm,_that.lastBallot);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? searchTerm,  Ballot? lastBallot)  get,required TResult Function( Map<String, dynamic> payload)  received,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.searchTerm,_that.lastBallot);case _Received():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? searchTerm,  Ballot? lastBallot)?  get,TResult? Function( Map<String, dynamic> payload)?  received,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.searchTerm,_that.lastBallot);case _Received() when received != null:
return received(_that.payload);case _:
...
class _Get implements BallotsEvent {
  const _Get({this.searchTerm, this.lastBallot});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.searchTerm, searchTerm) || other.searchTerm == searchTerm)&&(identical(other.lastBallot, lastBallot) || other.lastBallot == lastBallot));
}
...
@override
String toString() {
  return 'BallotsEvent.get(searchTerm: $searchTerm, lastBallot: $lastBallot)';
}
