...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  List<User> users, @JsonKey(name: 'last_message')  Message? lastMessage,  List<Message> messages,  List<int> blockers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Chat() when $default != null:
return $default(_that.id,_that.users,_that.lastMessage,_that.messages,_that.blockers);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  List<User> users, @JsonKey(name: 'last_message')  Message? lastMessage,  List<Message> messages,  List<int> blockers)  $default,) {final _that = this;
switch (_that) {
case _Chat():
return $default(_that.id,_that.users,_that.lastMessage,_that.messages,_that.blockers);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  List<User> users, @JsonKey(name: 'last_message')  Message? lastMessage,  List<Message> messages,  List<int> blockers)?  $default,) {final _that = this;
switch (_that) {
case _Chat() when $default != null:
return $default(_that.id,_that.users,_that.lastMessage,_that.messages,_that.blockers);case _:
  return null;
