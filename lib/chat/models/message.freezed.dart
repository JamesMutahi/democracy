...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,chatId,author,text,post,ballot,survey,petition,meeting,section,image1Url,image2Url,image3Url,image4Url,videoUrl,fileUrl,location,isRead,isEdited,isDeleted,createdAt,updatedAt]);

@override
String toString() {
  return 'Message(id: $id, chatId: $chatId, author: $author, text: $text, post: $post, ballot: $ballot, survey: $survey, petition: $petition, meeting: $meeting, section: $section, image1Url: $image1Url, image2Url: $image2Url, image3Url: $image3Url, image4Url: $image4Url, videoUrl: $videoUrl, fileUrl: $fileUrl, location: $location, isRead: $isRead, isEdited: $isEdited, isDeleted: $isDeleted, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'chat') int chatId, User author, String text, Post? post, Ballot? ballot, Survey? survey, Petition? petition, Meeting? meeting, Section? section,@JsonKey(name: 'image1') String? image1Url,@JsonKey(name: 'image2') String? image2Url,@JsonKey(name: 'image3') String? image3Url,@JsonKey(name: 'image4') String? image4Url,@JsonKey(name: 'video') String? videoUrl,@JsonKey(name: 'file') String? fileUrl, LatLng? location,@JsonKey(name: 'is_read') bool isRead,@JsonKey(name: 'is_edited') bool isEdited,@JsonKey(name: 'is_deleted') bool isDeleted,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt
});
...
as Section?,image1Url: freezed == image1Url ? _self.image1Url : image1Url // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'chat')  int chatId,  User author,  String text,  Post? post,  Ballot? ballot,  Survey? survey,  Petition? petition,  Meeting? meeting,  Section? section, @JsonKey(name: 'image1')  String? image1Url, @JsonKey(name: 'image2')  String? image2Url, @JsonKey(name: 'image3')  String? image3Url, @JsonKey(name: 'image4')  String? image4Url, @JsonKey(name: 'video')  String? videoUrl, @JsonKey(name: 'file')  String? fileUrl,  LatLng? location, @JsonKey(name: 'is_read')  bool isRead, @JsonKey(name: 'is_edited')  bool isEdited, @JsonKey(name: 'is_deleted')  bool isDeleted, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.chatId,_that.author,_that.text,_that.post,_that.ballot,_that.survey,_that.petition,_that.meeting,_that.section,_that.image1Url,_that.image2Url,_that.image3Url,_that.image4Url,_that.videoUrl,_that.fileUrl,_that.location,_that.isRead,_that.isEdited,_that.isDeleted,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'chat')  int chatId,  User author,  String text,  Post? post,  Ballot? ballot,  Survey? survey,  Petition? petition,  Meeting? meeting,  Section? section, @JsonKey(name: 'image1')  String? image1Url, @JsonKey(name: 'image2')  String? image2Url, @JsonKey(name: 'image3')  String? image3Url, @JsonKey(name: 'image4')  String? image4Url, @JsonKey(name: 'video')  String? videoUrl, @JsonKey(name: 'file')  String? fileUrl,  LatLng? location, @JsonKey(name: 'is_read')  bool isRead, @JsonKey(name: 'is_edited')  bool isEdited, @JsonKey(name: 'is_deleted')  bool isDeleted, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Message():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'chat')  int chatId,  User author,  String text,  Post? post,  Ballot? ballot,  Survey? survey,  Petition? petition,  Meeting? meeting,  Section? section, @JsonKey(name: 'image1')  String? image1Url, @JsonKey(name: 'image2')  String? image2Url, @JsonKey(name: 'image3')  String? image3Url, @JsonKey(name: 'image4')  String? image4Url, @JsonKey(name: 'video')  String? videoUrl, @JsonKey(name: 'file')  String? fileUrl,  LatLng? location, @JsonKey(name: 'is_read')  bool isRead, @JsonKey(name: 'is_edited')  bool isEdited, @JsonKey(name: 'is_deleted')  bool isDeleted, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.chatId,_that.author,_that.text,_that.post,_that.ballot,_that.survey,_that.petition,_that.meeting,_that.section,_that.image1Url,_that.image2Url,_that.image3Url,_that.image4Url,_that.videoUrl,_that.fileUrl,_that.location,_that.isRead,_that.isEdited,_that.isDeleted,_that.createdAt,_that.updatedAt);case _:
  return null;
