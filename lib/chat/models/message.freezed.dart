...
mixin _$Message {
 ...
 int get id; int get chat; User get user; String get text; Post? get post; Ballot? get ballot; Survey? get survey; Petition? get petition; Meeting? get meeting;@JsonKey(name: 'is_read') bool get isRead;@JsonKey(name: 'is_edited') bool get isEdited;@JsonKey(name: 'is_deleted') bool get isDeleted;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,chat,user,text,post,ballot,survey,petition,meeting,isRead,isEdited,isDeleted,createdAt,updatedAt);

@override
String toString() {
  return 'Message(id: $id, chat: $chat, user: $user, text: $text, post: $post, ballot: $ballot, survey: $survey, petition: $petition, meeting: $meeting, isRead: $isRead, isEdited: $isEdited, isDeleted: $isDeleted, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, int chat, User user, String text, Post? post, Ballot? ballot, Survey? survey, Petition? petition, Meeting? meeting,@JsonKey(name: 'is_read') bool isRead,@JsonKey(name: 'is_edited') bool isEdited,@JsonKey(name: 'is_deleted') bool isDeleted,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt
});


$UserCopyWith<$Res> get user;$PostCopyWith<$Res>? get post;$BallotCopyWith<$Res>? get ballot;$SurveyCopyWith<$Res>? get survey;$PetitionCopyWith<$Res>? get petition;$MeetingCopyWith<$Res>? get meeting;
...
as Meeting?,isRead: null == isRead ? _self.isRead : isRead // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.chat,_that.user,_that.text,_that.post,_that.ballot,_that.survey,_that.petition,_that.meeting,_that.isRead,_that.isEdited,_that.isDeleted,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
switch (_that) {
case _Message():
return $default(_that.id,_that.chat,_that.user,_that.text,_that.post,_that.ballot,_that.survey,_that.petition,_that.meeting,_that.isRead,_that.isEdited,_that.isDeleted,_that.createdAt,_that.updatedAt);}
}
...
@override $UserCopyWith<$Res> get user;@override $PostCopyWith<$Res>? get post;@override $BallotCopyWith<$Res>? get ballot;@override $SurveyCopyWith<$Res>? get survey;@override $PetitionCopyWith<$Res>? get petition;@override $MeetingCopyWith<$Res>? get meeting;
