...
class _Get implements RequestsEvent {
...
@override
String toString() {
  return 'RequestsEvent.get(searchTerm: $searchTerm, lastChat: $lastChat)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $RequestsEventCopyWith<$Res> {
...
class _Received implements RequestsEvent {
...
@override
String toString() {
  return 'RequestsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $RequestsEventCopyWith<$Res> {
...
class _Update implements RequestsEvent {
  const _Update();
