...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int chatId)?  load,TResult Function( Map<String, dynamic> payload)?  loaded,TResult Function( Chat chat)?  updated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that.chatId);case _Loaded() when loaded != null:
return loaded(_that.payload);case _Updated() when updated != null:
return updated(_that.chat);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int chatId)  load,required TResult Function( Map<String, dynamic> payload)  loaded,required TResult Function( Chat chat)  updated,}) {final _that = this;
switch (_that) {
case _Load():
return load(_that.chatId);case _Loaded():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int chatId)?  load,TResult? Function( Map<String, dynamic> payload)?  loaded,TResult? Function( Chat chat)?  updated,}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that.chatId);case _Loaded() when loaded != null:
return loaded(_that.payload);case _Updated() when updated != null:
...
class _Load implements ChatEvent {
  const _Load({required this.chatId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Load&&(identical(other.chatId, chatId) || other.chatId == chatId));
}
...
@override
String toString() {
  return 'ChatEvent.load(chatId: $chatId)';
}
...
/// @nodoc
abstract mixin class _$LoadCopyWith<$Res> implements $ChatEventCopyWith<$Res> {
...
class _Loaded implements ChatEvent {
...
@override
String toString() {
  return 'ChatEvent.loaded(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ChatEventCopyWith<$Res> {
...
class _Updated implements ChatEvent {
  const _Updated({required this.chat});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Updated&&(identical(other.chat, chat) || other.chat == chat));
}
...
@override
String toString() {
  return 'ChatEvent.updated(chat: $chat)';
}
...
/// @nodoc
abstract mixin class _$UpdatedCopyWith<$Res> implements $ChatEventCopyWith<$Res> {
