...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BlockedEvent);
}
...
/// @nodoc
class $BlockedEventCopyWith<$Res>  {
$BlockedEventCopyWith(BlockedEvent _, $Res Function(BlockedEvent) __);
}


/// Adds pattern-matching-related methods to [BlockedEvent].
extension BlockedEventPatterns on BlockedEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( User? lastUser)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( List<User> users)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.lastUser);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( User? lastUser)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( List<User> users)  update,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.lastUser);case _Received():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( User? lastUser)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( List<User> users)?  update,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.lastUser);case _Received() when received != null:
return received(_that.payload);case _Update() when update != null:
...
class _Get implements BlockedEvent {
  const _Get({this.lastUser});
  

 final  User? lastUser;

/// Create a copy of BlockedEvent
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.lastUser, lastUser) || other.lastUser == lastUser));
}
...
@override
String toString() {
  return 'BlockedEvent.get(lastUser: $lastUser)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $BlockedEventCopyWith<$Res> {
...
class _Received implements BlockedEvent {
...
@override
String toString() {
  return 'BlockedEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $BlockedEventCopyWith<$Res> {
...
class _Update implements BlockedEvent {
...
@override
String toString() {
  return 'BlockedEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $BlockedEventCopyWith<$Res> {
