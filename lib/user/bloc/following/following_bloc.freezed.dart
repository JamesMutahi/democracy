...
@override
String toString() {
  return 'FollowingEvent.get(userId: $userId, lastUser: $lastUser)';
}
...
class _Update implements FollowingEvent {
...
@override
String toString() {
  return 'FollowingEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $FollowingEventCopyWith<$Res> {
