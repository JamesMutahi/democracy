...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MutedEvent);
}
...
/// @nodoc
class $MutedEventCopyWith<$Res>  {
$MutedEventCopyWith(MutedEvent _, $Res Function(MutedEvent) __);
}


/// Adds pattern-matching-related methods to [MutedEvent].
extension MutedEventPatterns on MutedEvent {
...
class _Get implements MutedEvent {
  const _Get({this.lastUser});
  

 final  User? lastUser;

/// Create a copy of MutedEvent
...
@override
String toString() {
  return 'MutedEvent.get(lastUser: $lastUser)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $MutedEventCopyWith<$Res> {
...
class _Received implements MutedEvent {
...
@override
String toString() {
  return 'MutedEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $MutedEventCopyWith<$Res> {
...
class _Update implements MutedEvent {
...
@override
String toString() {
  return 'MutedEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $MutedEventCopyWith<$Res> {
