...
class _Update implements FollowersEvent {
...
@override
String toString() {
  return 'FollowersEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $FollowersEventCopyWith<$Res> {
