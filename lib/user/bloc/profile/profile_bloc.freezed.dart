...
/// @nodoc
abstract mixin class _$LoadCopyWith<$Res> implements $ProfileEventCopyWith<$Res> {
...
class _Loaded implements ProfileEvent {
...
@override
String toString() {
  return 'ProfileEvent.loaded(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ProfileEventCopyWith<$Res> {
...
class _Updated implements ProfileEvent {
  const _Updated({required this.user});
