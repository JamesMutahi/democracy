...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int sectionId)?  load,TResult Function( Map<String, dynamic> payload)?  loaded,TResult Function( Section section)?  updated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that.sectionId);case _Loaded() when loaded != null:
return loaded(_that.payload);case _Updated() when updated != null:
return updated(_that.section);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int sectionId)  load,required TResult Function( Map<String, dynamic> payload)  loaded,required TResult Function( Section section)  updated,}) {final _that = this;
switch (_that) {
case _Load():
return load(_that.sectionId);case _Loaded():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int sectionId)?  load,TResult? Function( Map<String, dynamic> payload)?  loaded,TResult? Function( Section section)?  updated,}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that.sectionId);case _Loaded() when loaded != null:
return loaded(_that.payload);case _Updated() when updated != null:
...
class _Load implements SectionEvent {
  const _Load({required this.sectionId});
  

 final  int sectionId;

/// Create a copy of SectionEvent
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Load&&(identical(other.sectionId, sectionId) || other.sectionId == sectionId));
}
...
@override
String toString() {
  return 'SectionEvent.load(sectionId: $sectionId)';
}
...
/// @nodoc
abstract mixin class _$LoadCopyWith<$Res> implements $SectionEventCopyWith<$Res> {
...
class _Loaded implements SectionEvent {
...
@override
String toString() {
  return 'SectionEvent.loaded(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $SectionEventCopyWith<$Res> {
...
class _Updated implements SectionEvent {
  const _Updated({required this.section});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Updated&&(identical(other.section, section) || other.section == section));
}
...
@override
String toString() {
  return 'SectionEvent.updated(section: $section)';
}
...
/// @nodoc
abstract mixin class _$UpdatedCopyWith<$Res> implements $SectionEventCopyWith<$Res> {
