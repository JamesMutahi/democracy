...
mixin _$Section {
 ...
 int get id; int get position; String? get tag; String get text;@JsonKey(name: 'is_title') bool get isTitle; List<Section> get subsections;@JsonKey(name: 'is_bookmarked') bool get isBookmarked;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,position,tag,text,isTitle,const DeepCollectionEquality().hash(subsections),isBookmarked);

@override
String toString() {
  return 'Section(id: $id, position: $position, tag: $tag, text: $text, isTitle: $isTitle, subsections: $subsections, isBookmarked: $isBookmarked)';
}
...
@useResult
$Res call({
 int id, int position, String? tag, String text,@JsonKey(name: 'is_title') bool isTitle, List<Section> subsections,@JsonKey(name: 'is_bookmarked') bool isBookmarked
});
...
/// Create a copy of Section
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? position = null,Object? tag = freezed,Object? text = null,Object? isTitle = null,Object? subsections = null,Object? isBookmarked = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int position,  String? tag,  String text, @JsonKey(name: 'is_title')  bool isTitle,  List<Section> subsections, @JsonKey(name: 'is_bookmarked')  bool isBookmarked)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Section() when $default != null:
return $default(_that.id,_that.position,_that.tag,_that.text,_that.isTitle,_that.subsections,_that.isBookmarked);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int position,  String? tag,  String text, @JsonKey(name: 'is_title')  bool isTitle,  List<Section> subsections, @JsonKey(name: 'is_bookmarked')  bool isBookmarked)  $default,) {final _that = this;
switch (_that) {
case _Section():
return $default(_that.id,_that.position,_that.tag,_that.text,_that.isTitle,_that.subsections,_that.isBookmarked);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int position,  String? tag,  String text, @JsonKey(name: 'is_title')  bool isTitle,  List<Section> subsections, @JsonKey(name: 'is_bookmarked')  bool isBookmarked)?  $default,) {final _that = this;
switch (_that) {
case _Section() when $default != null:
return $default(_that.id,_that.position,_that.tag,_that.text,_that.isTitle,_that.subsections,_that.isBookmarked);case _:
  return null;
...
class _Section implements Section {
  const _Section({required this.id, required this.position, required this.tag, required this.text, @JsonKey(name: 'is_title') required this.isTitle, required final  List<Section> subsections, @JsonKey(name: 'is_bookmarked') required this.isBookmarked}): _subsections = subsections;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,position,tag,text,isTitle,const DeepCollectionEquality().hash(_subsections),isBookmarked);
...
/// Create a copy of Section
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? position = null,Object? tag = freezed,Object? text = null,Object? isTitle = null,Object? subsections = null,Object? isBookmarked = null,}) {
