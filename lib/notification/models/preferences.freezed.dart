...
mixin _$Preferences {
  ...
  @JsonKey(name: 'allow_notifications') bool get allowNotifications;

  @JsonKey(
      name: 'allow_follow_notifications') bool get allowFollowNotifications;

  @JsonKey(name: 'allow_tag_notifications') bool get allowTagNotifications;

  @JsonKey(name: 'allow_like_notifications') bool get allowLikeNotifications;

  @JsonKey(name: 'allow_reply_notifications') bool get allowReplyNotifications;

  @JsonKey(
      name: 'allow_repost_notifications') bool get allowRepostNotifications;

  @JsonKey(
      name: 'allow_message_notifications') bool get allowMessageNotifications;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Preferences &&
            (identical(other.allowNotifications, allowNotifications) ||
                other.allowNotifications == allowNotifications) && (identical(
            other.allowFollowNotifications, allowFollowNotifications) ||
            other.allowFollowNotifications == allowFollowNotifications) &&
            (identical(other.allowTagNotifications, allowTagNotifications) ||
                other.allowTagNotifications == allowTagNotifications) &&
            (identical(other.allowLikeNotifications, allowLikeNotifications) ||
                other.allowLikeNotifications == allowLikeNotifications) &&
            (identical(
                other.allowReplyNotifications, allowReplyNotifications) ||
                other.allowReplyNotifications == allowReplyNotifications) &&
            (identical(
...
abstract mixin class $PreferencesCopyWith<$Res> {
  factory $PreferencesCopyWith(Preferences value,
      $Res Function(Preferences) _then) = _$PreferencesCopyWithImpl;

  @useResult
  $Res call({
    @JsonKey(name: 'allow_notifications') bool allowNotifications, @JsonKey(
        name: 'allow_follow_notifications') bool allowFollowNotifications, @JsonKey(
        name: 'allow_tag_notifications') bool allowTagNotifications, @JsonKey(
        name: 'allow_like_notifications') bool allowLikeNotifications, @JsonKey(
        name: 'allow_reply_notifications') bool allowReplyNotifications, @JsonKey(
        name: 'allow_repost_notifications') bool allowRepostNotifications, @JsonKey(
        name: 'allow_message_notifications') bool allowMessageNotifications
  });
...
class _$PreferencesCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? allowNotifications = null, Object? allowFollowNotifications = null, Object? allowTagNotifications = null, Object? allowLikeNotifications = null, Object? allowReplyNotifications = null, Object? allowRepostNotifications = null, Object? allowMessageNotifications = null,}) {
    return _then(_self.copyWith(
      allowNotifications: null == allowNotifications
          ? _self.allowNotifications
          : allowNotifications // ignore: cast_nullable_to_non_nullable
      as bool,
      allowFollowNotifications: null == allowFollowNotifications
          ? _self.allowFollowNotifications
          : allowFollowNotifications // ignore: cast_nullable_to_non_nullable
      as bool,
      allowTagNotifications: null == allowTagNotifications
          ? _self.allowTagNotifications
          : allowTagNotifications // ignore: cast_nullable_to_non_nullable
      as bool,
      allowLikeNotifications: null == allowLikeNotifications
          ? _self.allowLikeNotifications
          : allowLikeNotifications // ignore: cast_nullable_to_non_nullable
      as bool,
      allowReplyNotifications: null == allowReplyNotifications
          ? _self.allowReplyNotifications
          : allowReplyNotifications // ignore: cast_nullable_to_non_nullable
      as bool,
      allowRepostNotifications: null == allowRepostNotifications
          ? _self.allowRepostNotifications
          : allowRepostNotifications // ignore: cast_nullable_to_non_nullable
      as bool,
      allowMessageNotifications: null == allowMessageNotifications
          ? _self.allowMessageNotifications
...
extension PreferencesPatterns on Preferences {
  ...
  TResult Function( _Preferences value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _Preferences implements Preferences {
  const _Preferences({@JsonKey(
      name: 'allow_notifications') required this.allowNotifications, @JsonKey(
      name: 'allow_follow_notifications') required this.allowFollowNotifications, @JsonKey(
      name: 'allow_tag_notifications') required this.allowTagNotifications, @JsonKey(
      name: 'allow_like_notifications') required this.allowLikeNotifications, @JsonKey(
      name: 'allow_reply_notifications') required this.allowReplyNotifications, @JsonKey(
      name: 'allow_repost_notifications') required this.allowRepostNotifications, @JsonKey(
      name: 'allow_message_notifications') required this.allowMessageNotifications});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Preferences &&
            (identical(other.allowNotifications, allowNotifications) ||
                other.allowNotifications == allowNotifications) && (identical(
            other.allowFollowNotifications, allowFollowNotifications) ||
            other.allowFollowNotifications == allowFollowNotifications) &&
...
abstract mixin class _$PreferencesCopyWith<$Res>
    implements $PreferencesCopyWith<$Res> {
  factory _$PreferencesCopyWith(_Preferences value,
      $Res Function(_Preferences) _then) = __$PreferencesCopyWithImpl;
