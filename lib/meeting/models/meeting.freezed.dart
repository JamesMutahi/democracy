...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,host,title,description,county,constituency,ward,const DeepCollectionEquality().hash(speakers),const DeepCollectionEquality().hash(participants),participantsCount,isLiveStream,isActive,startTime,endTime);

@override
String toString() {
  return 'Meeting(id: $id, host: $host, title: $title, description: $description, county: $county, constituency: $constituency, ward: $ward, speakers: $speakers, participants: $participants, participantsCount: $participantsCount, isLiveStream: $isLiveStream, isActive: $isActive, startTime: $startTime, endTime: $endTime)';
}
...
@useResult
$Res call({
 int id, User host, String title, String description, County? county, Constituency? constituency, Ward? ward, List<User> speakers, List<User> participants,@JsonKey(name: 'participants_count') int participantsCount,@JsonKey(name: 'is_live_stream') bool isLiveStream,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'start_time') DateTime? startTime,@JsonKey(name: 'end_time') DateTime? endTime
});
...
/// Create a copy of Meeting
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? host = null,Object? title = null,Object? description = null,Object? county = freezed,Object? constituency = freezed,Object? ward = freezed,Object? speakers = null,Object? participants = null,Object? participantsCount = null,Object? isLiveStream = null,Object? isActive = null,Object? startTime = freezed,Object? endTime = freezed,}) {
...
as int,isLiveStream: null == isLiveStream ? _self.isLiveStream : isLiveStream // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  User host,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward,  List<User> speakers,  List<User> participants, @JsonKey(name: 'participants_count')  int participantsCount, @JsonKey(name: 'is_live_stream')  bool isLiveStream, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'start_time')  DateTime? startTime, @JsonKey(name: 'end_time')  DateTime? endTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Meeting() when $default != null:
return $default(_that.id,_that.host,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.speakers,_that.participants,_that.participantsCount,_that.isLiveStream,_that.isActive,_that.startTime,_that.endTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  User host,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward,  List<User> speakers,  List<User> participants, @JsonKey(name: 'participants_count')  int participantsCount, @JsonKey(name: 'is_live_stream')  bool isLiveStream, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'start_time')  DateTime? startTime, @JsonKey(name: 'end_time')  DateTime? endTime)  $default,) {final _that = this;
switch (_that) {
case _Meeting():
return $default(_that.id,_that.host,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.speakers,_that.participants,_that.participantsCount,_that.isLiveStream,_that.isActive,_that.startTime,_that.endTime);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  User host,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward,  List<User> speakers,  List<User> participants, @JsonKey(name: 'participants_count')  int participantsCount, @JsonKey(name: 'is_live_stream')  bool isLiveStream, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'start_time')  DateTime? startTime, @JsonKey(name: 'end_time')  DateTime? endTime)?  $default,) {final _that = this;
switch (_that) {
case _Meeting() when $default != null:
return $default(_that.id,_that.host,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.speakers,_that.participants,_that.participantsCount,_that.isLiveStream,_that.isActive,_that.startTime,_that.endTime);case _:
  return null;
...
class _Meeting implements Meeting {
  const _Meeting({required this.id, required this.host, required this.title, required this.description, required this.county, required this.constituency, required this.ward, required final  List<User> speakers, required final  List<User> participants, @JsonKey(name: 'participants_count') required this.participantsCount, @JsonKey(name: 'is_live_stream') required this.isLiveStream, @JsonKey(name: 'is_active') required this.isActive, @JsonKey(name: 'start_time') required this.startTime, @JsonKey(name: 'end_time') required this.endTime}): _speakers = speakers,_participants = participants;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,host,title,description,county,constituency,ward,const DeepCollectionEquality().hash(_speakers),const DeepCollectionEquality().hash(_participants),participantsCount,isLiveStream,isActive,startTime,endTime);
...
/// Create a copy of Meeting
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? host = null,Object? title = null,Object? description = null,Object? county = freezed,Object? constituency = freezed,Object? ward = freezed,Object? speakers = null,Object? participants = null,Object? participantsCount = null,Object? isLiveStream = null,Object? isActive = null,Object? startTime = freezed,Object? endTime = freezed,}) {
