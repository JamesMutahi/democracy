...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Meeting meeting,  User? lastUser)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( List<User> users)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.meeting,_that.lastUser);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Meeting meeting,  User? lastUser)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( List<User> users)  update,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.meeting,_that.lastUser);case _Received():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( Meeting meeting,  User? lastUser)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( List<User> users)?  update,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.meeting,_that.lastUser);case _Received() when received != null:
return received(_that.payload);case _Update() when update != null:
...
class _Get implements ParticipantsEvent {
  const _Get({required this.meeting, this.lastUser});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.meeting, meeting) || other.meeting == meeting)&&(identical(other.lastUser, lastUser) || other.lastUser == lastUser));
}


@override
int get hashCode => Object.hash(runtimeType,meeting,lastUser);

@override
String toString() {
  return 'ParticipantsEvent.get(meeting: $meeting, lastUser: $lastUser)';
}
...
@useResult
$Res call({
 Meeting meeting, User? lastUser
});


$MeetingCopyWith<$Res> get meeting;$UserCopyWith<$Res>? get lastUser;
...
/// Create a copy of ParticipantsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? meeting = null,Object? lastUser = freezed,}) {
  return _then(_Get(
meeting: null == meeting ? _self.meeting : meeting // ignore: cast_nullable_to_non_nullable
as Meeting,lastUser: freezed == lastUser ? _self.lastUser : lastUser // ignore: cast_nullable_to_non_nullable
as User?,
  ));
}
