...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int broadcastId)?  load,TResult Function( Map<String, dynamic> payload)?  loaded,TResult Function( Broadcast broadcast)?  updated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that.broadcastId);case _Loaded() when loaded != null:
return loaded(_that.payload);case _Updated() when updated != null:
return updated(_that.broadcast);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int broadcastId)  load,required TResult Function( Map<String, dynamic> payload)  loaded,required TResult Function( Broadcast broadcast)  updated,}) {final _that = this;
switch (_that) {
case _Load():
return load(_that.broadcastId);case _Loaded():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int broadcastId)?  load,TResult? Function( Map<String, dynamic> payload)?  loaded,TResult? Function( Broadcast broadcast)?  updated,}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that.broadcastId);case _Loaded() when loaded != null:
return loaded(_that.payload);case _Updated() when updated != null:
...
class _Load implements BroadcastEvent {
  const _Load({required this.broadcastId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Load&&(identical(other.broadcastId, broadcastId) || other.broadcastId == broadcastId));
}
...
@override
String toString() {
  return 'BroadcastEvent.load(broadcastId: $broadcastId)';
}
...
/// @nodoc
abstract mixin class _$LoadCopyWith<$Res> implements $BroadcastEventCopyWith<$Res> {
...
class _Loaded implements BroadcastEvent {
...
@override
String toString() {
  return 'BroadcastEvent.loaded(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $BroadcastEventCopyWith<$Res> {
...
class _Updated implements BroadcastEvent {
  const _Updated({required this.broadcast});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Updated&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast));
}
...
@override
String toString() {
  return 'BroadcastEvent.updated(broadcast: $broadcast)';
}
...
/// @nodoc
abstract mixin class _$UpdatedCopyWith<$Res> implements $BroadcastEventCopyWith<$Res> {
