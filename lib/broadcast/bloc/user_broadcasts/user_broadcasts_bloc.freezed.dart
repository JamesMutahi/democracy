...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserBroadcastsEvent);
}
...
/// @nodoc
class $UserBroadcastsEventCopyWith<$Res>  {
$UserBroadcastsEventCopyWith(UserBroadcastsEvent _, $Res Function(UserBroadcastsEvent) __);
}


/// Adds pattern-matching-related methods to [UserBroadcastsEvent].
extension UserBroadcastsEventPatterns on UserBroadcastsEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( User user,  List<Broadcast>? previousBroadcasts)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( Broadcast broadcast)?  add,TResult Function( Broadcast broadcast)?  update,TResult Function( int broadcastId)?  remove,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.user,_that.previousBroadcasts);case _Received() when received != null:
...
return remove(_that.broadcastId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( User user,  List<Broadcast>? previousBroadcasts)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( Broadcast broadcast)  add,required TResult Function( Broadcast broadcast)  update,required TResult Function( int broadcastId)  remove,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.user,_that.previousBroadcasts);case _Received():
return received(_that.payload);case _Add():
return add(_that.broadcast);case _Update():
return update(_that.broadcast);case _Remove():
return remove(_that.broadcastId);}
}
...
class _Get implements UserBroadcastsEvent {
  const _Get({required this.user, final  List<Broadcast>? previousBroadcasts}): _previousBroadcasts = previousBroadcasts;
  

 final  User user;
 final  List<Broadcast>? _previousBroadcasts;
 List<Broadcast>? get previousBroadcasts {
  final value = _previousBroadcasts;
  if (value == null) return null;
  if (_previousBroadcasts is EqualUnmodifiableListView) return _previousBroadcasts;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}


/// Create a copy of UserBroadcastsEvent
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.user, user) || other.user == user)&&const DeepCollectionEquality().equals(other._previousBroadcasts, _previousBroadcasts));
}


@override
int get hashCode => Object.hash(runtimeType,user,const DeepCollectionEquality().hash(_previousBroadcasts));

@override
String toString() {
  return 'UserBroadcastsEvent.get(user: $user, previousBroadcasts: $previousBroadcasts)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $UserBroadcastsEventCopyWith<$Res> {
  factory _$GetCopyWith(_Get value, $Res Function(_Get) _then) = __$GetCopyWithImpl;
@useResult
$Res call({
 User user, List<Broadcast>? previousBroadcasts
});
...
/// Create a copy of UserBroadcastsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? user = null,Object? previousBroadcasts = freezed,}) {
  return _then(_Get(
user: null == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as User,previousBroadcasts: freezed == previousBroadcasts ? _self._previousBroadcasts : previousBroadcasts // ignore: cast_nullable_to_non_nullable
as List<Broadcast>?,
  ));
}
...
class _Received implements UserBroadcastsEvent {
...
@override
String toString() {
  return 'UserBroadcastsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $UserBroadcastsEventCopyWith<$Res> {
...
class _Add implements UserBroadcastsEvent {
  const _Add({required this.broadcast});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Add&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast));
}
...
@override
String toString() {
  return 'UserBroadcastsEvent.add(broadcast: $broadcast)';
}
...
/// @nodoc
abstract mixin class _$AddCopyWith<$Res> implements $UserBroadcastsEventCopyWith<$Res> {
...
class _Update implements UserBroadcastsEvent {
  const _Update({required this.broadcast});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Update&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast));
}
...
@override
String toString() {
  return 'UserBroadcastsEvent.update(broadcast: $broadcast)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $UserBroadcastsEventCopyWith<$Res> {
...
class _Remove implements UserBroadcastsEvent {
  const _Remove({required this.broadcastId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Remove&&(identical(other.broadcastId, broadcastId) || other.broadcastId == broadcastId));
}
...
@override
String toString() {
  return 'UserBroadcastsEvent.remove(broadcastId: $broadcastId)';
}
...
/// @nodoc
abstract mixin class _$RemoveCopyWith<$Res> implements $UserBroadcastsEventCopyWith<$Res> {
