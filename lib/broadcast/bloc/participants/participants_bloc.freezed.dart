...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ParticipantsEvent);
}
...
/// @nodoc
class $ParticipantsEventCopyWith<$Res>  {
$ParticipantsEventCopyWith(ParticipantsEvent _, $Res Function(ParticipantsEvent) __);
}


/// Adds pattern-matching-related methods to [ParticipantsEvent].
extension ParticipantsEventPatterns on ParticipantsEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Broadcast broadcast,  User? lastUser)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( List<User> users)?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.broadcast,_that.lastUser);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Broadcast broadcast,  User? lastUser)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( List<User> users)  update,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.broadcast,_that.lastUser);case _Received():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( Broadcast broadcast,  User? lastUser)?  get,TResult? Function( Map<String, dynamic> payload)?  received,TResult? Function( List<User> users)?  update,}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.broadcast,_that.lastUser);case _Received() when received != null:
return received(_that.payload);case _Update() when update != null:
...
class _Get implements ParticipantsEvent {
  const _Get({required this.broadcast, this.lastUser});
  

 final  Broadcast broadcast;
 final  User? lastUser;

/// Create a copy of ParticipantsEvent
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast)&&(identical(other.lastUser, lastUser) || other.lastUser == lastUser));
}


@override
int get hashCode => Object.hash(runtimeType,broadcast,lastUser);

@override
String toString() {
  return 'ParticipantsEvent.get(broadcast: $broadcast, lastUser: $lastUser)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $ParticipantsEventCopyWith<$Res> {
  factory _$GetCopyWith(_Get value, $Res Function(_Get) _then) = __$GetCopyWithImpl;
@useResult
$Res call({
 Broadcast broadcast, User? lastUser
});


$BroadcastCopyWith<$Res> get broadcast;$UserCopyWith<$Res>? get lastUser;
...
/// Create a copy of ParticipantsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? broadcast = null,Object? lastUser = freezed,}) {
  return _then(_Get(
broadcast: null == broadcast ? _self.broadcast : broadcast // ignore: cast_nullable_to_non_nullable
as Broadcast,lastUser: freezed == lastUser ? _self.lastUser : lastUser // ignore: cast_nullable_to_non_nullable
as User?,
  ));
}
...
class _Received implements ParticipantsEvent {
...
@override
String toString() {
  return 'ParticipantsEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $ParticipantsEventCopyWith<$Res> {
...
class _Update implements ParticipantsEvent {
...
@override
String toString() {
  return 'ParticipantsEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $ParticipantsEventCopyWith<$Res> {
