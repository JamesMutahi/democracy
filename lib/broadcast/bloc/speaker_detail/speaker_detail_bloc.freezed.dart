...
class RequestToSpeak implements SpeakerDetailEvent {
  const RequestToSpeak({required this.broadcast});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RequestToSpeak&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast));
}
...
@override
String toString() {
  return 'SpeakerDetailEvent.requestToSpeak(broadcast: $broadcast)';
}
...
class MuteSpeaker implements SpeakerDetailEvent {
  const MuteSpeaker({required this.broadcast, required this.user});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MuteSpeaker&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast)&&(identical(other.user, user) || other.user == user));
}
...
@override
String toString() {
  return 'SpeakerDetailEvent.muteSpeaker(broadcast: $broadcast, user: $user)';
}
...
class MuteEveryone implements SpeakerDetailEvent {
  const MuteEveryone({required this.broadcast});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MuteEveryone&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast));
}
...
@override
String toString() {
  return 'SpeakerDetailEvent.muteEveryone(broadcast: $broadcast)';
}
