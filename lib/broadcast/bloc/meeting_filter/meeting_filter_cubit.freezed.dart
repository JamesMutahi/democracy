...
@override
String toString() {
  return 'MeetingFilterState(searchTerm: $searchTerm, isActive: $isActive, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
...
@override
String toString() {
  return 'MeetingFilterState.changed(searchTerm: $searchTerm, isActive: $isActive, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
