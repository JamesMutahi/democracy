...
@override
String toString() {
  return 'MeetingFilterState(searchTerm: $searchTerm, isOpen: $isOpen, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
...
@override
String toString() {
  return 'MeetingFilterState.changed(searchTerm: $searchTerm, isOpen: $isOpen, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
