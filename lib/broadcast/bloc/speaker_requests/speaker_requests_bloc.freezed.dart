...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Broadcast broadcast,  List<SpeakerRequest> previousRequests)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( SpeakerRequest request)?  add,TResult Function( SpeakerRequest request)?  update,TResult Function( int requestId)?  remove,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.broadcast,_that.previousRequests);case _Received() when received != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Broadcast broadcast,  List<SpeakerRequest> previousRequests)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( SpeakerRequest request)  add,required TResult Function( SpeakerRequest request)  update,required TResult Function( int requestId)  remove,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.broadcast,_that.previousRequests);case _Received():
...
class _Get implements SpeakerRequestsEvent {
  const _Get({required this.broadcast, final  List<SpeakerRequest> previousRequests = const []}): _previousRequests = previousRequests;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Get&&(identical(other.broadcast, broadcast) || other.broadcast == broadcast)&&const DeepCollectionEquality().equals(other._previousRequests, _previousRequests));
}


@override
int get hashCode => Object.hash(runtimeType,broadcast,const DeepCollectionEquality().hash(_previousRequests));

@override
String toString() {
  return 'SpeakerRequestsEvent.get(broadcast: $broadcast, previousRequests: $previousRequests)';
}
...
@useResult
$Res call({
 Broadcast broadcast, List<SpeakerRequest> previousRequests
});
...
/// Create a copy of SpeakerRequestsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? broadcast = null,Object? previousRequests = null,}) {
  return _then(_Get(
broadcast: null == broadcast ? _self.broadcast : broadcast // ignore: cast_nullable_to_non_nullable
as Broadcast,previousRequests: null == previousRequests ? _self._previousRequests : previousRequests // ignore: cast_nullable_to_non_nullable
