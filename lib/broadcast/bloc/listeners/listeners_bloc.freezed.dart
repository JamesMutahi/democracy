...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ListenersEvent);
}
...
/// @nodoc
class $ListenersEventCopyWith<$Res>  {
$ListenersEventCopyWith(ListenersEvent _, $Res Function(ListenersEvent) __);
}


/// Adds pattern-matching-related methods to [ListenersEvent].
extension ListenersEventPatterns on ListenersEvent {
...
class _Get implements ListenersEvent {
...
/// Create a copy of ListenersEvent
...
@override
String toString() {
  return 'ListenersEvent.get(broadcast: $broadcast, lastUser: $lastUser)';
}
...
/// @nodoc
abstract mixin class _$GetCopyWith<$Res> implements $ListenersEventCopyWith<$Res> {
...
class _Received implements ListenersEvent {
...
@override
String toString() {
  return 'ListenersEvent.received(payload: $payload)';
}
...
/// @nodoc
abstract mixin class _$ReceivedCopyWith<$Res> implements $ListenersEventCopyWith<$Res> {
...
class _Update implements ListenersEvent {
...
@override
String toString() {
  return 'ListenersEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $ListenersEventCopyWith<$Res> {
