...
mixin _$Broadcast {
 ...
 int get id; User get host;@BroadcastTypeConverter() BroadcastType get type;@JsonKey(name: 'co_hosts') List<User> get coHosts; String get title; String get description; County? get county; Constituency? get constituency; Ward? get ward; List<User> get speakers; List<User> get participants;@JsonKey(name: 'participants_count') int get participantsCount;@JsonKey(name: 'muted') List<int> get muted;@JsonKey(name: 'has_started') bool get hasStarted;@JsonKey(name: 'has_ended') bool get hasEnded;@JsonKey(name: 'recording_url') String? get recordingUrl;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'start_time') DateTime get startTime;@JsonKey(name: 'end_time') DateTime? get endTime;
...
@useResult
$Res call({
 int id, User host,@BroadcastTypeConverter() BroadcastType type,@JsonKey(name: 'co_hosts') List<User> coHosts, String title, String description, County? county, Constituency? constituency, Ward? ward, List<User> speakers, List<User> participants,@JsonKey(name: 'participants_count') int participantsCount,@JsonKey(name: 'muted') List<int> muted,@JsonKey(name: 'has_started') bool hasStarted,@JsonKey(name: 'has_ended') bool hasEnded,@JsonKey(name: 'recording_url') String? recordingUrl,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'start_time') DateTime startTime,@JsonKey(name: 'end_time') DateTime? endTime
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  User host, @BroadcastTypeConverter()  BroadcastType type, @JsonKey(name: 'co_hosts')  List<User> coHosts,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward,  List<User> speakers,  List<User> participants, @JsonKey(name: 'participants_count')  int participantsCount, @JsonKey(name: 'muted')  List<int> muted, @JsonKey(name: 'has_started')  bool hasStarted, @JsonKey(name: 'has_ended')  bool hasEnded, @JsonKey(name: 'recording_url')  String? recordingUrl, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'start_time')  DateTime startTime, @JsonKey(name: 'end_time')  DateTime? endTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Broadcast() when $default != null:
return $default(_that.id,_that.host,_that.type,_that.coHosts,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.speakers,_that.participants,_that.participantsCount,_that.muted,_that.hasStarted,_that.hasEnded,_that.recordingUrl,_that.isActive,_that.startTime,_that.endTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  User host, @BroadcastTypeConverter()  BroadcastType type, @JsonKey(name: 'co_hosts')  List<User> coHosts,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward,  List<User> speakers,  List<User> participants, @JsonKey(name: 'participants_count')  int participantsCount, @JsonKey(name: 'muted')  List<int> muted, @JsonKey(name: 'has_started')  bool hasStarted, @JsonKey(name: 'has_ended')  bool hasEnded, @JsonKey(name: 'recording_url')  String? recordingUrl, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'start_time')  DateTime startTime, @JsonKey(name: 'end_time')  DateTime? endTime)  $default,) {final _that = this;
switch (_that) {
case _Broadcast():
return $default(_that.id,_that.host,_that.type,_that.coHosts,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.speakers,_that.participants,_that.participantsCount,_that.muted,_that.hasStarted,_that.hasEnded,_that.recordingUrl,_that.isActive,_that.startTime,_that.endTime);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  User host, @BroadcastTypeConverter()  BroadcastType type, @JsonKey(name: 'co_hosts')  List<User> coHosts,  String title,  String description,  County? county,  Constituency? constituency,  Ward? ward,  List<User> speakers,  List<User> participants, @JsonKey(name: 'participants_count')  int participantsCount, @JsonKey(name: 'muted')  List<int> muted, @JsonKey(name: 'has_started')  bool hasStarted, @JsonKey(name: 'has_ended')  bool hasEnded, @JsonKey(name: 'recording_url')  String? recordingUrl, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'start_time')  DateTime startTime, @JsonKey(name: 'end_time')  DateTime? endTime)?  $default,) {final _that = this;
switch (_that) {
case _Broadcast() when $default != null:
return $default(_that.id,_that.host,_that.type,_that.coHosts,_that.title,_that.description,_that.county,_that.constituency,_that.ward,_that.speakers,_that.participants,_that.participantsCount,_that.muted,_that.hasStarted,_that.hasEnded,_that.recordingUrl,_that.isActive,_that.startTime,_that.endTime);case _:
  return null;
