...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is County&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
/// Adds pattern-matching-related methods to [County].
extension CountyPatterns on County {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _County value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _County() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _County value)  $default,){
final _that = this;
switch (_that) {
case _County():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _County value)?  $default,){
final _that = this;
switch (_that) {
case _County() when $default != null:
return $default(_that);case _:
...
class _County implements County {
  const _County({required this.id, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _County&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
