...
mixin _$Choice {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Choice &&
...
abstract mixin class $ChoiceCopyWith<$Res> {
  factory $ChoiceCopyWith(Choice value,
      $Res Function(Choice) _then) = _$ChoiceCopyWithImpl;
...
class _$ChoiceCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? number = null, Object? question = null, Object? text = null,}) {
...
extension ChoicePatterns on Choice {
  ...
  TResult Function( _Choice value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _Choice implements Choice {
  const _Choice(
      {required this.id, required this.number, required this.question, required this.text});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Choice &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.number, number) || other.number == number) &&
            (identical(other.question, question) ||
                other.question == question) &&
...
abstract mixin class _$ChoiceCopyWith<$Res> implements $ChoiceCopyWith<$Res> {
  factory _$ChoiceCopyWith(_Choice value,
      $Res Function(_Choice) _then) = __$ChoiceCopyWithImpl;
