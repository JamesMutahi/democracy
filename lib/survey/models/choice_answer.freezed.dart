...
mixin _$ChoiceAnswer {
  ...
  $ChoiceAnswerCopyWith<ChoiceAnswer> get copyWith =>
      _$ChoiceAnswerCopyWithImpl<ChoiceAnswer>(
          this as ChoiceAnswer, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ChoiceAnswer &&
...
abstract mixin class $ChoiceAnswerCopyWith<$Res> {
  factory $ChoiceAnswerCopyWith(ChoiceAnswer value,
      $Res Function(ChoiceAnswer) _then) = _$ChoiceAnswerCopyWithImpl;
...
class _$ChoiceAnswerCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? question = null, Object? choice = null,}) {
...
extension ChoiceAnswerPatterns on ChoiceAnswer {
  ...
  TResult Function( _ChoiceAnswer value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _ChoiceAnswer implements ChoiceAnswer {
  ...
  factory _ChoiceAnswer.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChoiceAnswerCopyWith<_ChoiceAnswer> get copyWith =>
      __$ChoiceAnswerCopyWithImpl<_ChoiceAnswer>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ChoiceAnswer &&
            (identical(other.question, question) ||
                other.question == question) &&
            (identical(other.choice, choice) || other.choice == choice));
  }
...
/// @nodoc
abstract mixin class _$ChoiceAnswerCopyWith<$Res>
    implements $ChoiceAnswerCopyWith<$Res> {
  factory _$ChoiceAnswerCopyWith(_ChoiceAnswer value,
      $Res Function(_ChoiceAnswer) _then) = __$ChoiceAnswerCopyWithImpl;
  ...
  @override $ChoiceCopyWith<$Res> get choice;
