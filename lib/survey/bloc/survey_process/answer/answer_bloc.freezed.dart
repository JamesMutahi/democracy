...
return submit(_that);case _Submitted() when submitted != null:
...
return submit(_that);case _Submitted():
...
return validate(_that.questions);case _Submit() when submit != null:
return submit(_that.survey,_that.startTime,_that.endTime,_that.textAnswers,_that.choiceAnswers);case _Submitted() when submitted != null:
...
return validate(_that.questions);case _Submit():
return submit(_that.survey,_that.startTime,_that.endTime,_that.textAnswers,_that.choiceAnswers);case _Submitted():
return submitted(_that.payload);}
}
...
class _Submit implements AnswerEvent {
  const _Submit({required this.survey, required this.startTime, required this.endTime, required final  List<TextAnswer> textAnswers, required final  List<ChoiceAnswer> choiceAnswers}): _textAnswers = textAnswers,_choiceAnswers = choiceAnswers;
...
@override
String toString() {
  return 'AnswerEvent.submit(survey: $survey, startTime: $startTime, endTime: $endTime, textAnswers: $textAnswers, choiceAnswers: $choiceAnswers)';
}
...
/// @nodoc
abstract mixin class _$SubmitCopyWith<$Res> implements $AnswerEventCopyWith<$Res> {
