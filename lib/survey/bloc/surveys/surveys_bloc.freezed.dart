...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? searchTerm,  List<Survey>? previousSurveys,  bool? isOpen,  String? sortBy,  bool? filterByRegion,  DateTime? startDate,  DateTime? endDate)?  get,TResult Function( Map<String, dynamic> payload)?  received,TResult Function( Survey survey)?  add,TResult Function( Survey survey)?  update,TResult Function( int surveyId)?  remove,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Get() when get != null:
return get(_that.searchTerm,_that.previousSurveys,_that.isOpen,_that.sortBy,_that.filterByRegion,_that.startDate,_that.endDate);case _Received() when received != null:
return received(_that.payload);case _Add() when add != null:
return add(_that.survey);case _Update() when update != null:
return update(_that.survey);case _Remove() when remove != null:
return remove(_that.surveyId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? searchTerm,  List<Survey>? previousSurveys,  bool? isOpen,  String? sortBy,  bool? filterByRegion,  DateTime? startDate,  DateTime? endDate)  get,required TResult Function( Map<String, dynamic> payload)  received,required TResult Function( Survey survey)  add,required TResult Function( Survey survey)  update,required TResult Function( int surveyId)  remove,}) {final _that = this;
switch (_that) {
case _Get():
return get(_that.searchTerm,_that.previousSurveys,_that.isOpen,_that.sortBy,_that.filterByRegion,_that.startDate,_that.endDate);case _Received():
return received(_that.payload);case _Add():
return add(_that.survey);case _Update():
return update(_that.survey);case _Remove():
return remove(_that.surveyId);}
}
...
class _Get implements SurveysEvent {
  const _Get({this.searchTerm, final  List<Survey>? previousSurveys, this.isOpen, this.sortBy, this.filterByRegion, this.startDate, this.endDate}): _previousSurveys = previousSurveys;
...
@override
int get hashCode => Object.hash(runtimeType,searchTerm,const DeepCollectionEquality().hash(_previousSurveys),isOpen,sortBy,filterByRegion,startDate,endDate);

@override
String toString() {
  return 'SurveysEvent.get(searchTerm: $searchTerm, previousSurveys: $previousSurveys, isOpen: $isOpen, sortBy: $sortBy, filterByRegion: $filterByRegion, startDate: $startDate, endDate: $endDate)';
}
...
@useResult
$Res call({
 String? searchTerm, List<Survey>? previousSurveys, bool? isOpen, String? sortBy, bool? filterByRegion, DateTime? startDate, DateTime? endDate
});
...
/// Create a copy of SurveysEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? searchTerm = freezed,Object? previousSurveys = freezed,Object? isOpen = freezed,Object? sortBy = freezed,Object? filterByRegion = freezed,Object? startDate = freezed,Object? endDate = freezed,}) {
  return _then(_Get(
...
as List<Survey>?,isOpen: freezed == isOpen ? _self.isOpen : isOpen // ignore: cast_nullable_to_non_nullable
...
class _Add implements SurveysEvent {
  const _Add({required this.survey});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Add&&(identical(other.survey, survey) || other.survey == survey));
}
...
@override
String toString() {
  return 'SurveysEvent.add(survey: $survey)';
}
...
/// @nodoc
abstract mixin class _$AddCopyWith<$Res> implements $SurveysEventCopyWith<$Res> {
...
class _Update implements SurveysEvent {
  const _Update({required this.survey});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Update&&(identical(other.survey, survey) || other.survey == survey));
}
...
@override
String toString() {
  return 'SurveysEvent.update(survey: $survey)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $SurveysEventCopyWith<$Res> {
...
class _Remove implements SurveysEvent {
  const _Remove({required this.surveyId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Remove&&(identical(other.surveyId, surveyId) || other.surveyId == surveyId));
}
...
@override
String toString() {
  return 'SurveysEvent.remove(surveyId: $surveyId)';
}
...
/// @nodoc
abstract mixin class _$RemoveCopyWith<$Res> implements $SurveysEventCopyWith<$Res> {
