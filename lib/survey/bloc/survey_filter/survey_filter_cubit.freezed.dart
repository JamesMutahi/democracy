...
@override
String toString() {
  return 'SurveyFilterState(searchTerm: $searchTerm, isOpen: $isOpen, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
...
@override
String toString() {
  return 'SurveyFilterState.changed(searchTerm: $searchTerm, isOpen: $isOpen, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
