...
@override
String toString() {
  return 'SurveyFilterState(searchTerm: $searchTerm, isActive: $isActive, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
...
@override
String toString() {
  return 'SurveyFilterState.changed(searchTerm: $searchTerm, isActive: $isActive, filterByRegion: $filterByRegion, sortBy: $sortBy, startDate: $startDate, endDate: $endDate, count: $count)';
}
