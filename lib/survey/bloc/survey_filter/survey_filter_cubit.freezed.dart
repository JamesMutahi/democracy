...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SurveyFilterState&&(identical(other.searchTerm, searchTerm) || other.searchTerm == searchTerm)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate));
}
...
@override
String toString() {
  return 'SurveyFilterState(searchTerm: $searchTerm, startDate: $startDate, endDate: $endDate)';
}
...
@override
String toString() {
  return 'SurveyFilterState.changed(searchTerm: $searchTerm, startDate: $startDate, endDate: $endDate)';
}
