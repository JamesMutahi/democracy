...
class _Update implements SupportersEvent {
...
@override
String toString() {
  return 'SupportersEvent.update(users: $users)';
}
...
/// @nodoc
abstract mixin class _$UpdateCopyWith<$Res> implements $SupportersEventCopyWith<$Res> {
