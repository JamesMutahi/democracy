...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PetitionFilterState&&(identical(other.searchTerm, searchTerm) || other.searchTerm == searchTerm)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate));
}
...
@override
String toString() {
  return 'PetitionFilterState(searchTerm: $searchTerm, startDate: $startDate, endDate: $endDate)';
}
...
@override
String toString() {
  return 'PetitionFilterState.changed(searchTerm: $searchTerm, startDate: $startDate, endDate: $endDate)';
}
