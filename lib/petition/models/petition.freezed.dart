...
mixin _$Petition {
 ...
 int get id; String get title; String get description; String? get image; String? get video; int get supporters;@JsonKey(name: 'recent_supporters') List<User> get recentSupporters;@JsonKey(name: 'start_time') DateTime get startTime;@JsonKey(name: 'end_time') DateTime get endTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,image,video,supporters,const DeepCollectionEquality().hash(recentSupporters),startTime,endTime);

@override
String toString() {
  return 'Petition(id: $id, title: $title, description: $description, image: $image, video: $video, supporters: $supporters, recentSupporters: $recentSupporters, startTime: $startTime, endTime: $endTime)';
}
...
@useResult
$Res call({
 int id, String title, String description, String? image, String? video, int supporters,@JsonKey(name: 'recent_supporters') List<User> recentSupporters,@JsonKey(name: 'start_time') DateTime startTime,@JsonKey(name: 'end_time') DateTime endTime
});
...
/// Create a copy of Petition
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? image = freezed,Object? video = freezed,Object? supporters = null,Object? recentSupporters = null,Object? startTime = null,Object? endTime = null,}) {
...
switch (_that) {
case _Petition() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.image,_that.video,_that.supporters,_that.recentSupporters,_that.startTime,_that.endTime);case _:
  return orElse();
...
switch (_that) {
case _Petition():
return $default(_that.id,_that.title,_that.description,_that.image,_that.video,_that.supporters,_that.recentSupporters,_that.startTime,_that.endTime);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,image,video,supporters,const DeepCollectionEquality().hash(_recentSupporters),startTime,endTime);
...
/// Create a copy of Petition
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? image = freezed,Object? video = freezed,Object? supporters = null,Object? recentSupporters = null,Object? startTime = null,Object? endTime = null,}) {
